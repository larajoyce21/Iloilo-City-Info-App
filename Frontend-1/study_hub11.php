...
$query = "SELECT * FROM study_hubs WHERE id = 11";
...
if (!empty($hub['transportation_routes'])) {
    $routes_data = json_decode($hub['transportation_routes'], true);
...
$amenities = [];
if (!empty($hub['amenities'])) {
    $amenities_data = json_decode($hub['amenities'], true);
...
if (!empty($hub['image_detail'])) {
    $detail_images = array_filter(explode(',', $hub['image_detail']));
}

$social_links = [];
if (!empty($hub['social_media'])) {
    $social_links = array_filter(array_map('trim', explode("\n", $hub['social_media'])));
}

$nearby_places = [];
if (!empty($hub['nearby_places'])) {
    $nearby_data = json_decode($hub['nearby_places'], true);
...
<head>
    ...
    <title><?php echo $hub['name'] ?? 'Study Hub'; ?> - Study Hub & Co-working Space</title>
    ...
    <style>
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= $hub['image'] ?? '' ?>');
...
<br>
    ...
    <section class="hero-section"
        ...
        url('<?= $hub['image'] ?? '' ?>') center/cover no-repeat;">
        <div class="container">
            <h1 class="display-4 fw-bold mb-3"><?= $hub['name'] ?? 'Study Hub' ?></h1>
            <p class="lead"><?= $hub['location'] ?? '' ?></p>
        </div>
    </section>

    <main class="container mb-4">
        <section class="content-section">
            <h2 class="section-title">About <?= $hub['name'] ?? 'this Study Hub' ?></h2>
            <div class="lead mb-4">
                <?= nl2br($hub['description'] ?? '') ?>
            </div>
                ...
                <div class="slideshow-container">
                    <?php foreach ($detail_images as $index => $image): ?>
                        <div class="slide <?= $index === 0 ? 'active' : '' ?>">
                            <img src="<?= trim($image) ?>" alt="<?= $hub['name'] ?? 'Study Hub' ?> Image <?= $index + 1 ?>">
        ...
        <section class="content-section">
            <h2 class="section-title">📌 Study Hub Information</h2>
            ...
            <div class="row d-none d-md-flex">
                    ...
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($hub['capacity'])): ?>
                                <p><strong>Capacity:</strong> <?php echo $hub['capacity']; ?> people</p>
                            <?php endif; ?>
                            <?php if (!empty($hub['type'])): ?>
                                <p><strong>Type:</strong> <?php echo $hub['type']; ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <p class="mb-2">📲 Phone: <?= $hub['contact'] ?? '' ?></p>
                            <?php if (!empty($hub['email'])): ?>
                                <p class="mb-2">📧 Email: <?= $hub['email'] ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($hub['website'])): ?>
                                <p class="mb-2">🌐 Website: <a href="<?= $hub['website'] ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <?php if (!empty($hub['capacity'])): ?>
                                    <p class="mb-1 small"><strong>Capacity:</strong> <?php echo $hub['capacity']; ?> people</p>
                                <?php endif; ?>
                                <?php if (!empty($hub['type'])): ?>
                                    <p class="mb-0 small"><strong>Type:</strong> <?php echo $hub['type']; ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body small">
                                <p class="mb-0 small"><?php echo nl2br($hub['hours'] ?? 'Hours not specified'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="card info-card">
                            ...
                            <div class="card-body">
                            <p class="mb-2 small">📲 Phone: <?= $hub['contact'] ?? '' ?></p>
                            <?php if (!empty($hub['email'])): ?>
                                <p class="mb-2 small">📧 Email: <?= $hub['email'] ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($hub['website'])): ?>
                                <p class="mb-2 small">🌐 Website: <a href="<?= $hub['website'] ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <section class="content-section">
            ...
            <div class="row">
                <div class="col-lg-8 mb-3">
                                    ...
                                    <?php foreach ($amenities as $amenity): ?>
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            <div class="amenity-item">
                                                ...
                                                <div class="small"><?php echo $amenity; ?></div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="alert alert-info py-2 small">No amenities listed</div>
                    <?php endif; ?>
                </div>
            </div>
        </section>
        ...
        <section class="content-section">
            ...
            <div class="row">
                <div class="col-lg-8 mb-3">
                    <?php if (!empty($hub['maps_embed'])): ?>
                        <div class="map-container">
                            <iframe src="<?= $hub['maps_embed'] ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy"></iframe>
                        </div>
                    <?php else: ?>
                    ...
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($nearby_places)): ?>
                                <p class="mb-2 small">Explore these places near <?= $hub['name'] ?? '' ?>:</p>
                            ...
                            <div class="d-flex flex-wrap gap-1">
                                <?php if (!empty($hub['maps_link'])): ?>
                                    <a href="<?= $hub['maps_link'] ?>" class="btn btn-outline-primary btn-sm" target="_blank">
                                        <i class="fas fa-map-marked-alt me-1"></i> Maps
                                    </a>
                                <?php endif; ?>
                                
                                <?php if (!empty($hub['directions_link'])): ?>
                                    <a href="<?= $hub['directions_link'] ?>" class="btn btn-primary btn-sm" target="_blank">
                    ...
                    <?php if (!empty($social_links)): ?>
                        <div class="card info-card">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (!empty($hub['mobile_app'])): ?>
                                    <hr class="my-3">
                                    <div class="d-flex flex-wrap gap-1">
                                        <a href="<?= $hub['mobile_app'] ?>" class="btn btn-dark btn-sm" target="_blank">
