...
if (isset($_GET['search'])) {
    ...
    if ($_SESSION['search_trigger']['table'] === 'cafes') {
...
<br>
    ...
    <br>
    <br>
    <h1 class="page-title text-light text-center">Cafés in Iloilo City</h1>

        <div class="card-container">
            <?php if ($cafes_exist): ?>
                <?php while ($cafe = $result->fetch_assoc()): ?>
                    <div class="card shadow-sm">
                        <img src="<?= htmlspecialchars($cafe['image']) ?>" class="card-img-top" alt="<?= htmlspecialchars($cafe['name']) ?>">
                        <div class="card-body text-center">
                            <h6 class="card-title"><?= htmlspecialchars($cafe['name']) ?></h6>
                            <?php if (!empty($cafe['details_link'])): ?>
                                <a href="<?= htmlspecialchars($cafe['details_link']) ?>" class="card-button">
                                    View Details
                                </a>
                            <?php else: ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <div class="alert alert-info">No cafes found.</div>
            <?php endif; ?>
        </div>
