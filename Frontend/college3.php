...
$query = "SELECT * FROM colleges WHERE id = 3"; 
...
if (!empty($college['transportation_routes'])) {
    $routes_data = json_decode($college['transportation_routes'], true);
...
$nearby_places = [];
if (!empty($college['nearby_places'])) {
    $raw = trim($college['nearby_places']);
    ...
    if (json_last_error() === JSON_ERROR_NONE && is_array($decoded)) {
        ...
        $nearby_places = array_values(array_filter($parts, function($v) { return $v !== ''; }));
    }
}

$hours = [];
if (!empty($college['hours'])) {
    $hours_text = $college['hours'];
    $hours = array_map('trim', preg_split('/\r\n|\r|\n/', $hours_text));
} else {
    $hours_text = '';
}
$detail_images = !empty($college['image_detail']) ? array_filter(explode(',', $college['image_detail'])) : [];
$social_links = !empty($college['social_media']) ? array_filter(array_map('trim', explode("\n", $college['social_media']))) : [];

$college_name = htmlspecialchars($college['name']);
$college_location = htmlspecialchars($college['location']);
$college_description = nl2br(htmlspecialchars($college['description']));
$college_image = htmlspecialchars($college['image']);
?>
...
<head>
    ...
    <title><?= $college_name ?> - Iloilo Education</title>
    ...
    <style>
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= $college_image ?>');
...
<section class="hero-section" 
  style="background:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)),url('<?= $college_image ?>') center/cover no-repeat;">
  <div class="container">
    <h1 class="display-4 fw-bold mb-3"><?= $college_name ?></h1>
    <p class="lead"><?= $college_location ?></p>
  </div>
</section>

  <main class="container mb-4">
    <section class="content-section">
      <h2 class="section-title">About <?= $college_name ?></h2>
      <div class="lead mb-4">
        <?= $college_description ?>
      </div>
        ...
        <div class="slideshow-container">
          <?php foreach ($detail_images as $index => $image): ?>
            <div class="slide <?= $index === 0 ? 'active' : '' ?>">
              <img src="<?= htmlspecialchars($image) ?>" alt="<?= $college_name ?> Image <?= $index + 1 ?>">
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">📜 College History</h5>
                    </div>
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($college['history'])) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($college['accreditation'])) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($college['programs'])) ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">📜 College History</h6>
                        </div>
                        <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($college['history'])) ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">🏆 Accreditation</h6>
                        </div>
                        <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($college['accreditation'])) ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="card info-card">
                        <div class="card-header">
                            <h6 class="mb-0">📚 Academic Programs</h6>
                        </div>
                        <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($college['programs'])) ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="content-section">
        ...
        <div class="row d-none d-md-flex">
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-info-circle me-2"></i> College Details</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <?php if (!empty($college['fee'])): ?>
                                <div class="col-md-6 mb-2">
                                    <h6 class="fw-bold">💵 Tuition Fees</h6>
                                    <p class="mb-2"><?= nl2br(htmlspecialchars($college['fee'])) ?></p>
                                </div>
                            <?php endif; ?>
                            
                            <div class="col-12">
                                <h6 class="fw-bold">📞 Contact</h6>
                                <p class="mb-2">📲 Phone: <?= htmlspecialchars($college['contact'] ?? 'Not available') ?></p>
                                <?php if (!empty($college['email'])): ?>
                                    <p class="mb-2">📧 Email: <?= htmlspecialchars($college['email']) ?> </p>
                                <?php endif; ?>
                                <?php if (!empty($college['website'])): ?>
                                    <p class="mb-2">🌐 Website: <a href="<?= htmlspecialchars($college['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($college['admission'])): ?>
                            <div class="admission-info">
                                <p class="mb-0"><?= nl2br(htmlspecialchars($college['admission'])) ?></p>
                            </div>
                        <?php else: ?>
                            <div class="alert alert-info mb-0 py-2 small">No admission information available.</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0"><i class="fas fa-info-circle me-2"></i> College Details</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <?php if (!empty($college['fee'])): ?>
                                    <div class="col-12 mb-2">
                                        ...
                                        <p class="mb-2 small"><?= nl2br(htmlspecialchars($college['fee'])) ?></p>
                                    </div>
                                <?php endif; ?>
                                
                                <div class="col-12">
                                    <h6 class="fw-bold small">📞 Contact</h6>
                                    <p class="mb-2 small">📲 Phone: <?= htmlspecialchars($college['contact'] ?? 'Not available') ?></p>
                                    <?php if (!empty($college['email'])): ?>
                                        <p class="mb-2 small">📧 Email: <?= htmlspecialchars($college['email']) ?> </p>
                                    <?php endif; ?>
                                    <?php if (!empty($college['website'])): ?>
                                        <p class="mb-2 small">🌐 Website: <a href="<?= htmlspecialchars($college['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($college['admission'])): ?>
                                <div class="admission-info">
                                    <p class="mb-0 small"><?= nl2br(htmlspecialchars($college['admission'])) ?></p>
                                </div>
                            <?php else: ?>
                                <div class="alert alert-info mb-0 py-2 small">No admission information available.</div>
                            <?php endif; ?>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">💡 College Facts</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-2"><strong>📅 Founded:</strong> <?= htmlspecialchars($college['year_founded']) ?></p>
                                <p class="mb-2"><strong>🏢 Type:</strong> <?= htmlspecialchars($college['type']) ?></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-2"><strong>🧑‍🎓 Students:</strong> <?= htmlspecialchars($college['students']) ?></p>
                                <p class="mb-2"><strong>💵 Tuition Range:</strong> <?= htmlspecialchars($college['fee']) ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?= nl2br(htmlspecialchars($hours_text)) ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">💡 College Facts</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-1 small"><strong>📅 Founded:</strong> <?= htmlspecialchars($college['year_founded']) ?></p>
                                    <p class="mb-1 small"><strong>🏢 Type:</strong> <?= htmlspecialchars($college['type']) ?></p>
                                    <p class="mb-1 small"><strong>🧑‍🎓 Students:</strong> <?= htmlspecialchars($college['students']) ?></p>
                                    <p class="mb-1 small"><strong>💵 Tuition Range:</strong> <?= htmlspecialchars($college['fee']) ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="content-section">
        ...
        <div class="row">
            <div class="col-lg-8 mb-3">
                <?php if (!empty($college['maps_embed'])): ?>
                    <div class="map-container">
                        <iframe src="<?= htmlspecialchars(convertToEmbedURL($college['maps_embed'])) ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy"></iframe>
                    </div>
                <?php else: ?>
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($nearby_places)): ?>
                            <p class="mb-2 small">Explore these places near <?= htmlspecialchars($college['name'] ?? '') ?>:</p>
                        ...
                        <div class="d-flex flex-wrap gap-1">
                            <?php if (!empty($college['maps_link'])): ?>
                                <a href="<?= htmlspecialchars($college['maps_link']) ?>" class="btn btn-outline-primary btn-sm" target="_blank">
                                    <i class="fas fa-map-marked-alt me-1"></i> Maps
                                </a>
                            <?php endif; ?>
                            
                            <?php if (!empty($college['directions_link'])): ?>
                                <a href="<?= htmlspecialchars($college['directions_link']) ?>" class="btn btn-primary btn-sm" target="_blank">
                ...
                <?php if (!empty($social_links)): ?>
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($college['mobile_app'])): ?>
                                <hr class="my-3">
                                <div class="d-flex flex-wrap gap-1">
                                    <a href="<?= htmlspecialchars($college['mobile_app']) ?>" class="btn btn-dark btn-sm" target="_blank">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p class="small text-white mb-0">&copy; 2026 Iloilo City Tourism Office. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
