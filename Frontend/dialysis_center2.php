...
$query = "SELECT * FROM dialysis_centers WHERE id = 2";
...
if (!empty($center['services'])) {
    $decoded = json_decode($center['services'], true);
    $services = is_array($decoded) ? $decoded : [];
}

$equipment = [];
if (!empty($center['equipment'])) {
    $decoded = json_decode($center['equipment'], true);
    $equipment = is_array($decoded) ? $decoded : [];
}

$detail_images = array_filter(explode(',', $center['image_detail'] ?? ''));
...
$nearby_places = [];
if (!empty($center['nearby_places'])) {
    $decoded = json_decode($center['nearby_places'], true);
...
<head>
    ...
    <title><?= htmlspecialchars($center['name']) ?> - Iloilo Dialysis Centers</title>
...
<section class="hero-section" 
  ...
  <div class="container">
    ...
    <?php if (!empty($center['emergency_services']) && $center['emergency_services'] == 1): ?>
        <span class="emergency-badge">🆘 Emergency Services Available</span>
    <?php endif; ?>
  </div>
</section>
  ...
  <main class="container mb-4">
    ...
    <section class="content-section">
        <h2 class="section-title">🏥 Dialysis Center Information</h2>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">ℹ️ About Our Center</h5>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($center['year_established'])): ?>
                            <p class="mt-2 mb-0"><strong>Established:</strong> <?= htmlspecialchars($center['year_established']) ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                      <?= nl2br(htmlspecialchars($center['hours'])) ?>
                        ...
                        <?php if (!empty($center['emergency_services']) && $center['emergency_services'] == 1): ?>
                            <div class="mt-3">
                                <span class="emergency-badge">24/7 Emergency Services</span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                            <p class="mb-2">📲 Phone: <?= htmlspecialchars($center['contact'] ?? '') ?></p>
                            <?php if (!empty($center['email'])): ?>
                                <p class="mb-2">📧 Email: <?= htmlspecialchars($center['email']) ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($center['website'])): ?>
                                <p class="mb-2">🌐 Website: <a href="<?= htmlspecialchars($center['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">ℹ️ About Our Center</h6>
                        </div>
                        <div class="card-body">
                            <?php if (!empty($center['year_established'])): ?>
                                <p class="mt-2 mb-0 small"><strong>Established:</strong> <?= htmlspecialchars($center['year_established']) ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                      ...
                      <?= nl2br(htmlspecialchars($center['hours'])) ?>
                            ...
                            <?php if (!empty($center['emergency_services']) && $center['emergency_services'] == 1): ?>
                                <div class="mt-3">
                                    <span class="emergency-badge small">24/7 Emergency Services</span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            <p class="mb-2 small">📲 Phone: <?= htmlspecialchars($center['contact'] ?? '') ?></p>
                            <?php if (!empty($center['email'])): ?>
                                <p class="mb-2 small">📧 Email: <?= htmlspecialchars($center['email']) ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($center['website'])): ?>
                                <p class="mb-2 small">🌐 Website: <a href="<?= htmlspecialchars($center['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <section class="content-section">
        <h2 class="section-title">⚕️ Medical Services & Equipment</h2>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="alert alert-info py-2 small">No specific services listed</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                        ...
                        <?php if (!empty($equipment)): ?>
                            <div class="d-flex flex-wrap">
                                <?php foreach ($equipment as $item): ?>
                                    <span class="equipment-badge"><?= htmlspecialchars($item) ?></span>
                                <?php endforeach; ?>
                            </div>
                        <?php else: ?>
                            <div class="alert alert-info py-2 small">No equipment information available</div>
                        <?php endif; ?>
                        
                        <?php if (!empty($center['insurance_accepted'])): ?>
                            <hr class="my-3">
                            <h6 class="fw-bold small">Insurance Accepted:</h6>
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($center['insurance_accepted'])) ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">🔬 Medical Equipment</h6>
                        </div>
                        <div class="card-body">
                            <?php if (!empty($equipment)): ?>
                                <div class="d-flex flex-wrap">
                                    <?php foreach ($equipment as $item): ?>
                                        <span class="equipment-badge small"><?= htmlspecialchars($item) ?></span>
                                    <?php endforeach; ?>
                                </div>
                            <?php else: ?>
                                <div class="alert alert-info py-2 small">No equipment information available</div>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            <p class="mb-0 small"><strong>Insurance Accepted:</strong><br><?= nl2br(htmlspecialchars($center['insurance_accepted'])) ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($nearby_places)): ?>
                            <p class="mb-2 small">Explore these places near <?= htmlspecialchars($center['name'] ?? '') ?>:</p>
                            <div class="d-flex flex-wrap">
