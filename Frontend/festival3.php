...
$query = "SELECT * FROM festivals WHERE id = 3"; 
...
if (!empty($festival['transportation_routes'])) {
    $routes_data = json_decode($festival['transportation_routes'], true);
...
$amenities = [];
if (!empty($festival['amenities'])) {
    $amenities = json_decode($festival['amenities'], true);
...
$nearby_places = [];
if (!empty($festival['nearby_places'])) {
    $decoded = json_decode($festival['nearby_places'], true);
    $nearby_places = is_array($decoded) ? $decoded : [];
}

$detail_images = array_filter(explode(',', $festival['image_detail'] ?? ''));
$social_links = array_filter(array_map('trim', explode("\n", $festival['social_media'] ?? '')));

$hours = [];
if (!empty($festival['hours'])) {
    $lines = explode("\n", $festival['hours']);
...
<head>
    ...
    <title><?= htmlspecialchars($festival['name']) ?> - Iloilo Festivals</title>
    ...
    <style>
       ...
       /* Navbar */
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= htmlspecialchars($festival['image'] ?? 'img/default-dinagyang.jpg') ?>');
...
<section class="hero-section" 
  style="background:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)),url('<?= htmlspecialchars($festival['image'] ?? 'img/default-dinagyang.jpg') ?>') center/cover no-repeat;">
  <div class="container">
    <h1 class="display-4 fw-bold mb-3"><?= htmlspecialchars($festival['name'] ?? '') ?></h1>
    <p class="lead"><?= htmlspecialchars($festival['location'] ?? '') ?></p>
  </div>
</section>

<main class="container mb-4">
    <section class="content-section">
      <h2 class="section-title">About The Festival</h2>
      <div class="lead mb-4">
        <?= nl2br(htmlspecialchars($festival['description'] ?? '')) ?>
      </div>
        ...
        <div class="slideshow-container">
          <?php foreach ($detail_images as $index => $image): ?>
            <div class="slide <?= $index === 0 ? 'active' : '' ?>">
              <img src="<?= htmlspecialchars($image) ?>" alt="<?= htmlspecialchars($festival['name']) ?> Image <?= $index + 1 ?>">
    ...
    <section class="content-section">
        <h2 class="section-title">🎉 Festival Information</h2>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($festival['announcement'] ?? '')) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($festival['lineup'] ?? '')) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($festival['schedule'] ?? '')) ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($festival['announcement'] ?? '')) ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($festival['lineup'] ?? '')) ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($festival['schedule'] ?? '')) ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="content-section">
        ...
        <div class="row d-none d-md-flex">
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">⚠️ Visitor Tips</h5>
                    </div>
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($festival['visitor_tips'] ?? '')) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100 quick-facts-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-2"><strong>📅 Date:</strong> <?= htmlspecialchars($festival['event_date'] ?? '') ?></p>
                                <p class="mb-2"><strong>🕒 Duration:</strong> <?= htmlspecialchars($festival['duration'] ?? '') ?></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-2"><strong>🧑‍🤝‍🧑 Attendance:</strong> <?= htmlspecialchars($festival['attendance'] ?? '') ?></p>
                                <p class="mb-0"><strong>🗓️ Established:</strong> <?= htmlspecialchars($festival['established'] ?? '') ?></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">⚠️ Visitor Tips</h6>
                        </div>
                        <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($festival['visitor_tips'] ?? '')) ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-1 small"><strong>📅 Date:</strong> <?= htmlspecialchars($festival['event_date'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>🕒 Duration:</strong> <?= htmlspecialchars($festival['duration'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>🧑‍🤝‍🧑 Attendance:</strong> <?= htmlspecialchars($festival['attendance'] ?? '') ?></p>
                                    <p class="mb-0 small"><strong>🗓️ Established:</strong> <?= htmlspecialchars($festival['established'] ?? '') ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">⭐ Significance</h5>
                    </div>
                    <div class="card-body">
                        <p class="mb-0"><?= htmlspecialchars($festival['significance'] ?? '') ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                            <p class="mb-2">📲 Phone: <?= htmlspecialchars($festival['contact'] ?? '') ?></p>
                            <?php if (!empty($festival['email'])): ?>
                                <p class="mb-2">📧 Email: <?= htmlspecialchars($festival['email']) ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($festival['website'])): ?>
                                <p class="mb-2">🌐 Website: <a href="<?= htmlspecialchars($festival['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">⭐ Significance</h6>
                        </div>
                        <div class="card-body">
                            <p class="mb-0 small"><?= htmlspecialchars($festival['significance'] ?? '') ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <p class="mb-2 small">📲 Phone: <?= htmlspecialchars($festival['contact'] ?? '') ?></p>
                            <?php if (!empty($festival['email'])): ?>
                                <p class="mb-2 small">📧 Email: <?= htmlspecialchars($festival['email']) ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($festival['website'])): ?>
                                <p class="mb-2 small">🌐 Website: <a href="<?= htmlspecialchars($festival['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <section class="content-section">
        ...
        <div class="row">
            <div class="col-lg-8 mb-3">
                <?php if (!empty($festival['maps_embed'])): ?>
                    <div class="map-container">
                        <iframe src="<?= htmlspecialchars(convertToEmbedURL($festival['maps_embed'])) ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy"></iframe>
                    </div>
                <?php else: ?>
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($nearby_places)): ?>
                            <p class="mb-2 small">Explore these places near <?= htmlspecialchars($festival['name'] ?? '') ?>:</p>
                        ...
                        <div class="d-flex flex-wrap gap-1">
                            <?php if (!empty($festival['maps_link'])): ?>
                                <a href="<?= htmlspecialchars($festival['maps_link']) ?>" class="btn btn-outline-primary btn-sm" target="_blank">
                                    <i class="fas fa-map-marked-alt me-1"></i> Maps
                                </a>
                            <?php endif; ?>
                            
                            <?php if (!empty($festival['directions_link'])): ?>
                                <a href="<?= htmlspecialchars($festival['directions_link']) ?>" class="btn btn-primary btn-sm" target="_blank">
                ...
                <?php if (!empty($social_links)): ?>
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($festival['mobile_app'])): ?>
                                <hr class="my-3">
                                <div class="d-flex flex-wrap gap-1">
                                    <a href="<?= htmlspecialchars($festival['mobile_app']) ?>" class="btn btn-dark btn-sm" target="_blank">
