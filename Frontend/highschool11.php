...
$query = "SELECT * FROM highschools WHERE id = 11";
...
if (!empty($highschool['transportation_routes'])) {
    $routes_data = json_decode($highschool['transportation_routes'], true);
...
if (empty($transport_routes) && !empty($highschool['transportation_options'])) {
    $transport_options = explode("\n", $highschool['transportation_options']);
...
$detail_images = array_filter(explode(',', $highschool['image_detail'] ?? ''));
$social_links = array_filter(array_map('trim', explode("\n", $highschool['social_media'] ?? '')));

$hours = [];
if (!empty($highschool['hours'])) {
    $lines = explode("\n", $highschool['hours']);
...
$nearby_places = [];
if (!empty($highschool['nearby_places'])) {
    $nearby_places = json_decode($highschool['nearby_places'], true);
...
<html lang="en">
  <head>
    ...
    <title><?= htmlspecialchars($highschool['name']) ?> - Iloilo City</title>
    ...
    <style>
      :root {
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= htmlspecialchars($highschool['image'] ?? '') ?>');
...
<section class="hero-section" 
  ...
  url('<?= htmlspecialchars($highschool['image'] ?? '') ?>') center/cover no-repeat;">
  <div class="container">
    <h1 class="display-4 fw-bold mb-3"><?= htmlspecialchars($highschool['name'] ?? '') ?></h1>
    <p class="lead"><?= htmlspecialchars($highschool['location'] ?? '') ?></p>
  </div>
</section>

  <main class="container mb-4">
    <section class="content-section">
      <h2 class="section-title">About <?= htmlspecialchars($highschool['name'] ?? '  ') ?></h2>
      <div class="lead mb-4">
        <?= nl2br(htmlspecialchars($highschool['description'] ?? '')) ?>
      </div>
        ...
        <div class="slideshow-container">
          <?php foreach ($detail_images as $index => $image): ?>
            <div class="slide <?= $index === 0 ? 'active' : '' ?>">
              <img src="<?= htmlspecialchars($image) ?>" alt="<?= htmlspecialchars($highschool['name']) ?> Image <?= $index + 1 ?>">
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($highschool['academics'])): ?>
                            <p class="mb-0"><?= nl2br(htmlspecialchars($highschool['academics'])) ?></p>
                        <?php else: ?>
                            <p class="mb-0 small">Academic information not available.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($highschool['facilities'])): ?>
                            <p class="mb-0"><?= nl2br(htmlspecialchars($highschool['facilities'])) ?></p>
                        <?php else: ?>
                            <p class="mb-0 small">Facility information not available.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($highschool['achievements'])): ?>
                            <p class="mb-0"><?= nl2br(htmlspecialchars($highschool['achievements'])) ?></p>
                        <?php else: ?>
                            <p class="mb-0 small">Achievement information not available.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($highschool['academics'])): ?>
                                <p class="mb-0 small"><?= nl2br(htmlspecialchars($highschool['academics'])) ?></p>
                            <?php else: ?>
                                <p class="mb-0 small">Academic information not available.</p>
                            <?php endif; ?>
                        </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($highschool['facilities'])): ?>
                                <p class="mb-0 small"><?= nl2br(htmlspecialchars($highschool['facilities'])) ?></p>
                            <?php else: ?>
                                <p class="mb-0 small">Facility information not available.</p>
                            <?php endif; ?>
                        </div>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            <?php if (!empty($highschool['achievements'])): ?>
                                <p class="mb-0 small"><?= nl2br(htmlspecialchars($highschool['achievements'])) ?></p>
                            <?php else: ?>
                                <p class="mb-0 small">Achievement information not available.</p>
                            <?php endif; ?>
                        </div>
        ...
        <div class="row d-none d-md-flex">
                        ...
                        <div class="row">
                            <?php if (!empty($hours)): ?>
                                <div class="col-md-6 mb-2">
                                    <h6 class="fw-bold">🕒 School Hours</h6>
                            ...
                            <?php if (!empty($highschool['fees'])): ?>
                                <div class="col-md-6 mb-2">
                                    <h6 class="fw-bold">💵 Tuition Fees</h6>
                                    <p class="mb-2"><?= nl2br(htmlspecialchars($highschool['fees'])) ?></p>
                                </div>
                            <?php endif; ?>
                            
                            <p class="mb-2">📲 Phone: <?= htmlspecialchars($highschool['contact'] ?? '') ?></p>
                            <?php if (!empty($highschool['email'])): ?>
                                <p class="mb-2">📧 Email: <?= htmlspecialchars($highschool['email']) ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($highschool['website'])): ?>
                                <p class="mb-2">🌐 Website: <a href="<?= htmlspecialchars($highschool['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-5 mb-3">
                <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <div class="row">
                                 <?= nl2br(htmlspecialchars($highschool['hours'])) ?>
                            </div>
                        </div>
                </div>
            </div>
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-2 small"><strong>📅 Established:</strong> <?= htmlspecialchars($highschool['year_established'] ?? '') ?></p>
                                <p class="mb-2 small"><strong>🏫 School Type:</strong> <?= htmlspecialchars($highschool['school_type'] ?? '') ?></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-2 small"><strong>🧑‍🤝‍🧑 Student Population:</strong> <?= htmlspecialchars($highschool['population'] ?? '') ?></p>
                                <p class="mb-2 small"><strong>👩‍🏫 Class Size:</strong> <?= htmlspecialchars($highschool['class_size'] ?? '') ?></p>
                                <p class="mb-2 small"><strong>📜 Motto:</strong> <?= htmlspecialchars($highschool['motto'] ?? '') ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">                               
                                <?php if (!empty($highschool['fees'])): ?>
                                    <div class="col-12 mb-2">
                                        <h6 class="fw-bold small">💵 Tuition Fees</h6>
                                        <p class="mb-2 small"><?= nl2br(htmlspecialchars($highschool['fees'])) ?></p>
                                    </div>
                                <?php endif; ?>
                                
                            <p class="mb-2 small">📲 Phone: <?= htmlspecialchars($highschool['contact'] ?? '') ?></p>
                            <?php if (!empty($highschool['email'])): ?>
                                <p class="mb-2 small">📧 Email: <?= htmlspecialchars($highschool['email']) ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($highschool['website'])): ?>
                                <p class="mb-2 small">🌐 Website: <a href="<?= htmlspecialchars($highschool['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-1 small"><strong>📅 Established:</strong> <?= htmlspecialchars($highschool['year_established'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>🏫 School Type:</strong> <?= htmlspecialchars($highschool['school_type'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>🧑‍🤝‍🧑 Student Population:</strong> <?= htmlspecialchars($highschool['population'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>👩‍🏫 Class Size:</strong> <?= htmlspecialchars($highschool['class_size'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>📜 Motto:</strong> <?= htmlspecialchars($highschool['motto'] ?? '') ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="content-section">
        ...
        <div class="row">
            <div class="col-lg-8 mb-3">
                <?php if (!empty($highschool['maps_embed'])): ?>
                    <div class="map-container">
                        <iframe src="<?= htmlspecialchars(convertToEmbedURL($highschool['maps_embed'])) ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy"></iframe>
                    </div>
                <?php else: ?>
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($nearby_places)): ?>
                            <p class="mb-2 small">Explore these places near <?= htmlspecialchars($highschool['name'] ?? '') ?>:</p>
                        ...
                        <div class="d-flex flex-wrap gap-1">
                            <?php if (!empty($highschool['maps_link'])): ?>
                                <a href="<?= htmlspecialchars($highschool['maps_link']) ?>" class="btn btn-outline-primary btn-sm" target="_blank">
                                    <i class="fas fa-map-marked-alt me-1"></i> Maps
                                </a>
                            <?php endif; ?>
                            
                            <?php if (!empty($highschool['directions_link'])): ?>
                                <a href="<?= htmlspecialchars($highschool['directions_link']) ?>" class="btn btn-primary btn-sm" target="_blank">
                ...
                <?php if (!empty($social_links)): ?>
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($highschool['mobile_app'])): ?>
                                <hr class="my-3">
                                <div class="d-flex flex-wrap gap-1">
                                    <a href="<?= htmlspecialchars($highschool['mobile_app']) ?>" class="btn btn-dark btn-sm" target="_blank">
