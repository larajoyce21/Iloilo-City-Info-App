...
<br>
<br>
<h1 class="page-title text-light text-center">Local Information in Iloilo City</h1>
...
<div class="col-4 col-lg-3 mb-3">
            <a href="markets.php" class="text-decoration-none">
                <div class="card icon-card">
                    <div class="card-body text-center">
                        <i class="fas fa-store fa-2x"></i> 
                        <h6 class="card-title mt-2">Markets</h6>
                    </div>
                </div>
            </a>
        </div>
        ...
        <!-- Plaza -->
<div class="col-4 col-lg-3 mb-3">
            <a href="plaza.php" class="text-decoration-none">
                <div class="card icon-card">
                    <div class="card-body text-center">
                        <i class="fas fa-tree fa-2x"></i> 
                        <h6 class="card-title mt-2">Plaza</h6>
                    </div>
                </div>
            </a>
        </div>
        ...
        <!-- Elementary Schools -->
<div class="col-4 col-lg-3 mb-3">
            <a href="elementarys.php" class="text-decoration-none">
                <div class="card icon-card">
                    <div class="card-body text-center">
                        <i class="fas fa-child fa-2x"></i> 
                        <h6 class="card-title mt-2">Elementary Schools</h6>
                    </div>
                </div>
            </a>
        </div>
        ...
        <!-- High Schools -->
<div class="col-4 col-lg-3 mb-3">
            <a href="highschools.php" class="text-decoration-none">
                <div class="card icon-card">
                    <div class="card-body text-center">
                        <i class="fas fa-user-graduate fa-2x"></i> 
                        <h6 class="card-title mt-2">High Schools</h6>
                    </div>
                </div>
            </a>
        </div>
...
<div class="col-4 col-lg-3 mb-3">
            <a href="colleges.php" class="text-decoration-none">
                <div class="card icon-card ">
                    <div class="card-body text-center">
                        ...
                        <h6 class="card-title mt-2">Colleges</h6>
                    </div>
                </div>
            </a>
        </div>
        <!-- Government Agencies -->
<div class="col-4 col-lg-3 mb-3">
            <a href="agencies.php" class="text-decoration-none">
                <div class="card icon-card">
                    <div class="card-body text-center">
                        <i class="fas fa-building fa-2x"></i>
                        <h6 class="card-title mt-2">Government Agencies</h6>
                    </div>
                </div>
            </a>
        </div>
...
<div class="col-4 col-lg-3 mb-3">
            <a href="city_officials.php" class="text-decoration-none">
                <div class="card icon-card">
                    <div class="card-body text-center">
                        <i class="fas fa-user-tie fa-2x"></i>
                        <h6 class="card-title mt-2">Government Officials</h6>
                    </div>
                </div>
            </a>
        </div>
        ...
        <!-- Barangays -->
<div class="col-4 col-lg-3 mb-3">
            <a href="barangays.php" class="text-decoration-none">
                <div class="card icon-card">
                    <div class="card-body text-center">
                        <i class="fas fa-home fa-2x"></i>
                        <h6 class="card-title mt-2">Barangays</h6>
                    </div>
                </div>
            </a>
        </div>
        ...
        <!-- Districts -->
<div class="col-4 col-lg-3 mb-3">
            <a href="districts.php" class="text-decoration-none">
                <div class="card icon-card">
                    <div class="card-body text-center">
                        <i class="fas fa-map-marked-alt fa-2x"></i>
                        <h6 class="card-title mt-2">Districts of Iloilo City</h6>
                    </div>
                </div>
            </a>
        </div>
