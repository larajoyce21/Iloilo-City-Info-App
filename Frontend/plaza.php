...
$result = $conn->query("SELECT * FROM plaza");
...
if (isset($_GET['search'])) {
    ...
    if ($_SESSION['search_trigger']['table'] === 'plaza') {
...
<div class="album py-5" id="plazas">
    <div class="container">
        <br>
        <br>
        <br>
        <h1 class="fw-light text-light text-center">Plazas in Iloilo City </h1> 
        
        <div class="card-container">
            <?php if ($plaza_exist): ?>
                <?php while ($plaza = $result->fetch_assoc()): ?>
                    <div class="card shadow-sm">
                        <img src="<?= htmlspecialchars($plaza['image']) ?>" class="card-img-top" alt="<?= htmlspecialchars($plaza['name']) ?>">
                        <div class="card-body text-center">
                            <h6 class="card-title"><?= htmlspecialchars($plaza['name']) ?></h6>
                            <?php if (!empty($plaza['details_link'])): ?>
                                <a href="<?= htmlspecialchars($plaza['details_link']) ?>" class="card-button">
                                    View Details
                                </a>
                            <?php else: ?>
