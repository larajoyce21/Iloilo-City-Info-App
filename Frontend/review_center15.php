...
$query = "SELECT * FROM review_centers WHERE id = 15";
...
$courses = [];
if (!empty($center['courses'])) {
    $courses = json_decode($center['courses'], true);
    if (!is_array($courses)) {
        $courses = [];
    }
}
...
<head>
    ...
    <title><?php echo htmlspecialchars($center['name']); ?> - Iloilo Review Centers</title>
...
<section class="hero-section" 
  ...
  <main class="container mb-4">
    ...
    <section class="content-section">
        <h2 class="section-title">Review Center Information</h2>
                        ...
                        <?php if (!empty($courses)): ?>
                            <div class="d-flex flex-wrap">
                                <?php foreach ($courses as $course): ?>
                                    <span class="badge bg-danger badge-custom"><?php echo htmlspecialchars($course); ?></span>
                                <?php endforeach; ?>
                            </div>
                        <?php else: ?>
                            <p class="mb-0">No courses listed</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">📚 Courses Offered</h6>
                        </div>
                        <div class="card-body">
                            <?php if (!empty($courses)): ?>
                                <div class="d-flex flex-wrap">
                                    <?php foreach ($courses as $course): ?>
                                        <span class="badge bg-danger badge-custom small"><?php echo htmlspecialchars($course); ?></span>
                                    <?php endforeach; ?>
                                </div>
                            <?php else: ?>
                                <p class="mb-0 small">No courses listed</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
