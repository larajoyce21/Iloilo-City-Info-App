...
$query = "SELECT * FROM agricultural_stores WHERE id = 10";
...
if (!empty($store['product_categories'])) {
    $product_categories = json_decode($store['product_categories'], true);
...
$services_offered = [];
if (!empty($store['services_offered'])) {
    $services_offered = json_decode($store['services_offered'], true);
...
<head>
    ...
    <title><?php echo $store['name']; ?> - Agricultural & Farming Supply Store</title>
    ...
    <style>
     ...
     /* Navbar */
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= $store['image'] ?? '' ?>');
...
<br>
    <section class="hero-section" 
        style="background:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)),url('<?= $store['image'] ?? '' ?>') center/cover no-repeat;">
        <div class="container">
    ...
    <main class="container mb-4">
        ...
        <section class="content-section">
            <h2 class="section-title">🌱 Agricultural Store Information</h2>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h5 class="mb-0">🏪 Store Background</h5>
                        </div>
                        <div class="card-body">
                            <p class="mb-0"><?= nl2br($store['description'] ?? '') ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <p class="mb-0 text-muted">Services information not available.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-md-none mobile-side-by-side">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            <div class="card-header">
                                <h6 class="mb-0">🏪 Store Background</h6>
                            </div>
                            <div class="card-body">
                                <p class="mb-0 small"><?= nl2br($store['description'] ?? 'Information not available') ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <?php else: ?>
                                    <p class="mb-0 small text-muted">Services information not available.</p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <section class="content-section">
            <h2 class="section-title">About <?= $store['name'] ?? '' ?></h2>
            <div class="lead mb-4">
            </div>
                ...
                <div class="slideshow-container">
                    <?php foreach ($detail_images as $index => $image): ?>
                        <div class="slide <?= $index === 0 ? 'active' : '' ?>">
                            <img src="<?= $image ?>" alt="<?= $store['name'] ?> Image <?= $index + 1 ?>">
                            ...
                            <div class="row">
                                <?php if (!empty($store['price_range'])): ?>
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <p class="mb-2"><?= nl2br($store['price_range']) ?></p>
                                    </div>
                                <?php endif; ?>
                                <?php if (!empty($store['contact'])): ?>
                                    <p>📲 Phone: <?php echo $store['contact']; ?></p>
                                <?php endif; ?>
                                ...
                                <?php if (!empty($store['website'])): ?>
                                    <div class="col-12 mb-2">
                                        <p class="mb-2">🌐 Website: <a href="<?= $store['website'] ?>" target="_blank" class="text-decoration-none">Visit Website</a></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($hours)): ?>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <p class="mb-0 text-muted">Operating hours not specified.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <?php if (!empty($hours)): ?>
                                    <?php foreach ($hours as $hour): ?>
                                        <p class="mb-1 small"><?= $hour ?></p>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <p class="mb-0 small text-muted">Operating hours not specified.</p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="mb-2"><strong>📅 Established:</strong> <?= $store['established_year'] ?? 'Not specified' ?></p>
                                    <p class="mb-2"><strong>⭐ Specialty:</strong> <?= $store['specialty'] ?? 'Not specified' ?></p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-2"><strong>💵 Price Range:</strong> <?= $store['price_range'] ?? 'Not specified' ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <p class="mb-1 small"><strong>📅 Established:</strong> <?= $store['established_year'] ?? 'Not specified' ?></p>
                                        <p class="mb-1 small"><strong>⭐ Specialty:</strong> <?= $store['specialty'] ?? 'Not specified' ?></p>
                                        <p class="mb-1 small"><strong>💵 Price Range:</strong> <?= $store['price_range'] ?? 'Not specified' ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($nearby_places)): ?>
                                <p class="mb-2 small">Explore these places near <?= $store['name'] ?? '' ?>:</p>
                                <div class="d-flex flex-wrap">
                            ...
                            <div class="d-flex flex-wrap gap-1">
                                <?php if (!empty($store['maps_link'])): ?>
                                    <a href="<?= $store['maps_link'] ?>" class="btn btn-outline-primary btn-sm" target="_blank">
                                        <i class="fas fa-map-marked-alt me-1"></i> Maps
                                    </a>
                                <?php endif; ?>
                                
                                <?php if (!empty($store['directions_link'])): ?>
                                    <a href="<?= $store['directions_link'] ?>" class="btn btn-primary btn-sm" target="_blank">
                        ...
                        <div class="card info-card">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (!empty($store['mobile_app'])): ?>
                                    <hr class="my-3">
                                    <div class="d-flex flex-wrap gap-1">
                                        <a href="<?= $store['mobile_app'] ?>" class="btn btn-dark btn-sm" target="_blank">
        ...
        <div class="container">
            <div class="row row-cols-3 g-3 text-center text-sm-start">
                ...
                <div class="col">
                    ...
                    <img src="img/logo4.png" alt="Iloilo City Logo" class="img-fluid mb-2"  loading="lazy">
