...
$query = "SELECT * FROM banks WHERE id = 45";
...
$nearby_places = [];
if (!empty($bank['nearby_places'])) {
    $nearby_places = json_decode($bank['nearby_places'], true) ?: [];
}

$detail_images = array_filter(explode(',', $bank['image_detail'] ?? ''));
...
if (!empty($bank['transportation_routes'])) {
    $routes_data = json_decode($bank['transportation_routes'], true);
...
<head>
    ...
    <title><?= $bank['name'] ?? 'BPI Iloilo' ?> - Iloilo Banking Services</title>
    ...
    <style>
      :root {
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= $bank['image'] ?? '' ?>');
        ...
        /* Route List - Similar to apartment1.php */
        .route-list {
            background-color: #f8f9fa;
...
<br>
    <section class="hero-section" style="background:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)),url('<?= $bank['image'] ?? '' ?>') center/cover no-repeat;">
        <div class="container">
            <h1 class="display-4 fw-bold mb-3"><?= $bank['name'] ?? '' ?></h1>
            <p class="lead"><?= $bank['location'] ?? '' ?></p>
        </div>
    </section>
    ...
    <main class="container mb-4">
        <section class="content-section" id="about">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h2 class="section-title">About <?= $bank['name'] ?? '' ?></h2>
                    <div class="lead mb-4">
                ...
                <div class="slideshow-container mt-4">
                    <?php foreach ($detail_images as $index => $image): ?>
                        <div class="slide <?= $index === 0 ? 'active' : '' ?>">
                            <img src="<?= $image ?>" alt="<?= $bank['name'] ?? '' ?> Detail <?= $index + 1 ?>" loading="lazy">
        ...
        <section class="content-section" id="services">
            ...
            <div class="row d-none d-md-flex">
                <div class="col-lg-6 mb-4">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="fas fa-concierge-bell me-2"></i> Banking Services</h5>
                        </div>
                        <div class="card-body">
                            <?php if (!empty($bank['services'])): ?>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="fas fa-university me-2"></i> ATM & Accessibility</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <p class="ms-4"><?= !empty($bank['atm']) ? $bank['atm'] : '' ?></p>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="ms-4"><?= !empty($bank['accessibility']) ? $bank['accessibility'] : '' ?></p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="ms-4"><?= !empty($bank['type']) ? $bank['type'] : '' ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-md-none mobile-side-by-side">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            <div class="card-header">
                                <h6 class="mb-0"><i class="fas fa-concierge-bell me-2"></i> Banking Services</h6>
                            </div>
                            <div class="card-body">
                                <?php if (!empty($bank['services'])): ?>
                                    <ul class="service-list">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            <div class="card-header">
                                <h6 class="mb-0"><i class="fas fa-university me-2"></i> ATM & Accessibility</h6>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <p class="ms-4 small"><?= !empty($bank['atm']) ? $bank['atm'] : '' ?></p>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="ms-4 small"><?= !empty($bank['accessibility']) ? $bank['accessibility'] : '' ?></p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="ms-4 small"><?= !empty($bank['type']) ? $bank['type'] : '' ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row d-none d-md-flex">
                <div class="col-lg-6 mb-4">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h5 class="mb-0">    🕒 Banking Hours</h5>
                        </div>
                        <div class="card-body">
                                 <?php if (!empty($bank['hours'])): ?>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($bank['branches'])): ?>
                                <div class="list-group list-group-flush">
                                    <?php 
                                    $branch_count = 0;
                                    foreach (explode("\n", $bank['branches']) as $branch):
                                        if (trim($branch) != ''): 
                                            $branch_count++;
                                            ?>
                            ...
                            <?php else: ?>
                                <p class="text-muted">Branch information not available.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-md-none mobile-side-by-side">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            <div class="card-header">
                                <h6 class="mb-0">🕒 Banking Hours </h6>
                            </div>
                            <div class="card-body">
                                <?php if (!empty($bank['hours'])): ?>
                                    <div class="col-md-6 mb-4">
                                            ...
                                            if (trim($branch) != ''): 
                                                ...
                                                <div class="list-group-item border-0 px-0 py-1">
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <span class="small"><?= trim($branch) ?></span>
                                                    </div>
                                                </div>
                                            <?php endif;
                                        endforeach; ?>
        ...
        <section class="content-section" id="hours">
            ...
            <div class="row d-none d-md-flex">
                <div class="col-lg-8 mb-4">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="fas fa-info-circle me-2"></i> Branch Details</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">                              
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="mb-3">
                                        <h6>📲 Branch Phone</h6>
                                        <p class="ms-4"><?= !empty($bank['contact']) ? $bank['contact'] : '' ?></p>
                                    </div>
                                   
                                    <div class="mb-3">
                                        <h6> 📧 Email:</h6>
                                        <p class="ms-4"><?= !empty($bank['email']) ? $bank['email'] : '' ?></p>
                                    </div>
                                   
                                    <div>
                                        <h6>🚨 Emergency Hotline</h6>
                                        <p class="ms-4"><?= !empty($bank['hotline']) ? $bank['hotline'] : '' ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="card info-card quick-facts-card h-100">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <h6>Bank Type</h6>
                                <p><?= !empty($bank['type']) ? $bank['type'] : '' ?></p>
                            </div>
                            
                            <div class="mb-3">
                                <h6>Established</h6>
                                <p><?= !empty($bank['established']) ? $bank['established'] : '' ?></p>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <div class="mb-2">
                                    <h6 class="small">📲 Branch Phone: </h6>
                                    <p class="ms-4 small"><?= !empty($bank['contact']) ? $bank['contact'] : '' ?></p>
                                </div>
                               
                                <div class="mb-2">
                                    <h6 class="small">📧 Email: </h6>
                                    <p class="ms-4 small"><?= !empty($bank['email']) ? $bank['email'] : '' ?></p>
                                </div>
                               
                                <div>
                                    <h6 class="small">🚨 Hotline: </h6>
                                    <p class="ms-4 small"><?= !empty($bank['hotline']) ? $bank['hotline'] : '' ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-2">
                                        <h6 class="small">Bank Type</h6>
                                        <p class="small"><?= !empty($bank['type']) ? $bank['type'] : '' ?></p>
                                    </div>
                                    
                                    <div class="mb-2">
                                        <h6 class="small">Established</h6>
                                        <p class="small"><?= !empty($bank['established']) ? $bank['established'] : '' ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="content-section" id="location">
            ...
            <div class="row">
                <div class="col-lg-8 mb-4">
                    <?php if (!empty($bank['maps_embed'])): ?>
                        <div class="map-container">
                            <iframe src="<?= $bank['maps_embed'] ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    <?php else: ?>
                ...
                <div class="col-lg-4">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="fas fa-map-marked-alt me-2"></i> Nearby Places</h5>
                        </div>
                        <div class="card-body">
                            <?php if (!empty($nearby_places)): ?>
                                <p class="mb-3">Explore these places near <?= $bank['name'] ?? 'this bank' ?>:</p>
                                <div class="d-flex flex-wrap">
                                    <?php foreach ($nearby_places as $place): ?>
                                        <span class="badge bg-primary badge-custom"><?= $place ?></span>
                                    <?php endforeach; ?>
                                </div>
                            <?php else: ?>
                            ...
                            <h5 class="mb-3"><i class="fas fa-link me-2"></i> Useful Links</h5>
                            <div class="d-flex flex-wrap gap-2">
                                <?php if (!empty($bank['maps_link'])): ?>
                                    <a href="<?= $bank['maps_link'] ?>" class="btn btn-outline-primary btn-sm" target="_blank">
                                        <i class="fas fa-map-marked-alt me-1"></i> Google Maps
                                    </a>
                                <?php endif; ?>
                               
                                <?php if (!empty($bank['directions_link'])): ?>
                                    <a href="<?= $bank['directions_link'] ?>" class="btn btn-primary btn-sm" target="_blank">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card info-card">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="fas fa-car me-2"></i> Transportation Information</h5>
                        </div>
                        <div class="card-body">
                            <?php 
                    ...
                    <?php if (!empty($social_links)): ?>
                        <div class="card info-card">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (!empty($bank['mobile_app'])): ?>
                                    <hr class="my-4">
                                   
                                    <h5 class="mb-3"><i class="fas fa-mobile-alt me-2"></i> Mobile Banking</h5>
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="<?= $bank['mobile_app'] ?>" class="btn btn-dark btn-sm" target="_blank">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <?php if (!empty($bank['contact'])): ?>
                                        <a href="tel:<?= preg_replace('/[^0-9+]/', '', $bank['contact']) ?>" class="btn btn-outline-primary">
                                            <i class="fas fa-phone me-1"></i> Call Branch
                                        </a>
                                    <?php endif; ?>
                                    
                                    <?php if (!empty($bank['email'])): ?>
                                        <a href="mailto:<?= $bank['email'] ?>" class="btn btn-outline-secondary">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const bankDays = document.querySelectorAll('.bank-day');
        bankDays.forEach(day => {
            if (day.querySelector('h6').textContent.includes(today)) {
    ...
    function toggleTransport(type) {
        ...
        document.querySelectorAll('.route-list').forEach(list => {
            if (list.id !== 'route-' + type) {
                list.classList.remove('active');
            }
        });
        
        document.querySelectorAll('.transport-arrow').forEach(arrowElement => {
            if (arrowElement.id !== 'arrow-' + type) {
