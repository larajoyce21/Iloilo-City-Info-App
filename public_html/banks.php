...
if (isset($_GET['search'])) {
    ...
    if ($_SESSION['search_trigger']['table'] === 'banks') {
...
<div class="album py-5" id="banks">
    <div class="container">
        ...
        <br>
        <br>
        <h1 class="page-title text-light text-center">Banks in Iloilo City</h1> 
        
        <div class="card-container">
            <?php if ($banks_exist): ?>
                <?php while ($bank = $result->fetch_assoc()): ?>
                    <div class="card shadow-sm">
                        <img src="<?= htmlspecialchars($bank['image']) ?>" class="card-img-top" alt="<?= htmlspecialchars($bank['name']) ?>">
                        <div class="card-body text-center">
                            <h6 class="card-title"><?= htmlspecialchars($bank['name']) ?></h6>
                            <?php if (!empty($bank['details_link'])): ?>
                                <a href="<?= htmlspecialchars($bank['details_link']) ?>" class="card-button">
                                    View Details
                                </a>
                            <?php else: ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <div class="alert alert-info">No bank found.</div>
            <?php endif; ?>
        </div>
    </div>
</div>
