...
$query = "SELECT * FROM bicycle_shops WHERE id = 9";
...
if (!empty($shop['nearby_places'])) {
    $decoded = json_decode($shop['nearby_places'], true);
    $nearby_places = (json_last_error() === JSON_ERROR_NONE && is_array($decoded))
        ? $decoded
        : array_filter(array_map('trim', explode(',', $shop['nearby_places'])));
}

$detail_images = array_filter(explode(',', $shop['image_detail'] ?? ''));
...
<head>
    ...
    <title><?php echo htmlspecialchars($shop['name']); ?> - Bicycle Shop</title>
    ...
    <style>
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= htmlspecialchars($shop['image'] ?? 'img/default-bicycle-shop.jpg') ?>');
...
<br>
    <section class="hero-section"
        ...
        url('<?= htmlspecialchars($shop['image'] ?? 'img/default-bicycle-shop.jpg') ?>') center/cover no-repeat;">
        <div class="container">
    ...
    <main class="container mb-4">
        ...
        <section class="content-section">
            <h2 class="section-title">🚲 Bicycle Shop Information</h2>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <?php if (!empty($shop['bicycle_types'])): ?>
                                    <h6 class="mt-3 text-black">🚴 Bicycle Types Available:</h6>
                                    <p><?= htmlspecialchars($shop['bicycle_types']) ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    <p><strong>📲 Phone: </strong> <?= htmlspecialchars($shop['contact']) ?></p>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="col-md-6">
                                    <?php if (!empty($shop['website'])): ?>
                                        <p>🌐 Website:<a href="<?= htmlspecialchars($shop['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                                    <?php endif; ?>
                                </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 mb-4">
                        <?php if (!empty($shop['services'])): ?>
                            <div class="card info-card h-100">
                                ...
                                <div class="card-body">
                                    <?php 
                                        $services = explode(',', $shop['services']);
                                        foreach ($services as $service): 
                                    ?>
                                        <span class="service-badge"><?= htmlspecialchars(trim($service)) ?></span>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-6 mb-4">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <?php if (!empty($shop['bicycle_types'])): ?>
                                    <h6 class="mt-2 text-black small">🚴 Bicycle Types:</h6>
                                    <p class="small"><?= htmlspecialchars($shop['bicycle_types']) ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 mb-4">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <p class="small"><?= nl2br(htmlspecialchars($shop['hours'])) ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                    <p class="small"><strong>📲 Phone: </strong> <?= htmlspecialchars($shop['contact']) ?></p>
                                    <p class="small"><strong>📧 Email: </strong> <?= htmlspecialchars($shop['email']) ?></p>

                                <?php if (!empty($shop['website'])): ?>
                                    <p class="small">🌐 Website: <a href="<?= htmlspecialchars($shop['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card info-card h-100">
                                ...
                                <div class="card-body">
                                    <?php 
                                        ...
                                        foreach ($services as $service): 
                                    ?>
                                        <span class="service-badge d-block small mb-1"><?= htmlspecialchars(trim($service)) ?></span>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($nearby_places)): ?>
                                <p class="mb-3">Explore these places near <?= htmlspecialchars($shop['name'] ?? '') ?>:</p>
