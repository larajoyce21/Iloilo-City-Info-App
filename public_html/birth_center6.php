...
$query = "SELECT * FROM birth_centers WHERE id = 6";
...
if (!empty($center['transportation_routes'])) {
    $routes_data = json_decode($center['transportation_routes'], true);
...
if (!empty($center['services'])) {
    $services = json_decode($center['services'], true);
...
if (!empty($center['image_detail'])) {
    $detail_images = explode(',', $center['image_detail']);
}

$social_links = array_filter(array_map('trim', explode("\n", $center['social_media'] ?? '')));

$hours = [];
if (!empty($center['hours'])) {
    $hours = explode("\n", $center['hours']);
}

$facilities = [];
if (!empty($center['facilities'])) {
    $decoded = json_decode($center['facilities'], true);
    $facilities = is_array($decoded) ? $decoded : [];
}
$social_media = [];
if (!empty($center['social_media'])) {
    $lines = explode("\n", $center['social_media']);
...
<head>
    ...
    <title><?php echo htmlspecialchars($center['name']); ?> - Birth Center</title>
    ...
    <style>
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= htmlspecialchars($center['image'] ?? '') ?>');
...
<br>
    <section class="hero-section" 
        style="background:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)),url('<?= htmlspecialchars($center['image'] ?? '') ?>') center/cover no-repeat;">
        <div class="container">
            <h1 class="display-4 fw-bold mb-3"><?= htmlspecialchars($center['name'] ?? '') ?></h1>
            <p class="lead"><?= htmlspecialchars($center['location'] ?? '') ?></p>
        </div>
    </section>

    <main class="container mb-4">
        <section class="content-section">
            <h2 class="section-title">About <?= htmlspecialchars($center['name'] ?? '') ?></h2>
            <div class="lead mb-4">
                <?= nl2br(htmlspecialchars($center['description'] ?? '')) ?>
            </div>
                ...
                <div class="slideshow-container">
                    <?php foreach ($detail_images as $index => $image): ?>
                        <div class="slide <?= $index === 0 ? 'active' : '' ?>">
                            <img src="<?= htmlspecialchars($image) ?>" alt="<?= htmlspecialchars($center['name']) ?> Image <?= $index + 1 ?>">
        ...
        <section class="content-section">
            <h2 class="section-title">🏥 Birth Center Information</h2>
            ...
            <div class="row d-none d-md-flex">
                    ...
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($center['type'])): ?>
                                <p class="mb-0 mt-2"><strong>Type:</strong> <?php echo htmlspecialchars($center['type']); ?></p>
                            <?php endif; ?>
                            <?php if (!empty($center['accreditation'])): ?>
                                <p class="mb-0"><strong>Accreditation:</strong> <?php echo htmlspecialchars($center['accreditation']); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                             <?= nl2br(htmlspecialchars($center['hours'])) ?>

                            
                            <?php if (!empty($center['emergency_hours'])): ?>
                                <hr>
                                <h6 class="fw-bold">Emergency Hours:</h6>
                                <?php echo nl2br(htmlspecialchars($center['emergency_hours'])); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <p class="mb-2">📲 Phone: <?php echo htmlspecialchars($center['contact']); ?></p>
                            <?php if (!empty($center['emergency_contact'])): ?>
                                <p class="mb-2">📞 Emergency: <?php echo htmlspecialchars($center['emergency_contact']); ?></p>
                            <?php endif; ?>
                            <?php if (!empty($center['email'])): ?>
                                <p class="mb-0">📧 Email: <?php echo htmlspecialchars($center['email']); ?></p>
                            <?php endif; ?><br>
                            <?php if (!empty($center['website'])): ?>
                                <p class="mb-2">🌐 Website: <a href="<?php echo htmlspecialchars($center['website']); ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                <?php if (!empty($center['type'])): ?>
                                    <p class="mb-0 mt-2 small"><strong>Type:</strong> <?php echo htmlspecialchars($center['type']); ?></p>
                                <?php endif; ?>
                                <?php if (!empty($center['accreditation'])): ?>
                                    <p class="mb-0 small"><strong>Accreditation:</strong> <?php echo htmlspecialchars($center['accreditation']); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body small">
                             <?= nl2br(htmlspecialchars($center['hours'])) ?>
                                ...
                                <?php if (!empty($center['emergency_hours'])): ?>
                                    <hr>
                                    <h6 class="fw-bold small">Emergency Hours:</h6>
                                    <p class="mb-0 small"><?php echo nl2br(htmlspecialchars($center['emergency_hours'])); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="card info-card">
                            ...
                            <div class="card-body">
                                <p class="mb-2 small">📲 Phone: <?php echo htmlspecialchars($center['contact']); ?></p>
                                <?php if (!empty($center['emergency_contact'])): ?>
                                    <p class="mb-2 small">📞 Emergency:  <?php echo htmlspecialchars($center['emergency_contact']); ?></p>
                                <?php endif; ?>
                                <?php if (!empty($center['email'])): ?>
                                    <p class="mb-0 small">📧 Email:  <?php echo htmlspecialchars($center['email']); ?></p>
                                <?php endif; ?>
                                <?php if (!empty($center['website'])): ?>
                                    <p class="mb-2 small">🌐 Website: <a href="<?php echo htmlspecialchars($center['website']); ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <?php if (!empty($services) || !empty($facilities)): ?>
            <section class="content-section">
                <h2 class="section-title">💊 Services & Facilities</h2>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap">
                                    <?php foreach ($services as $service): ?>
                                        <span class="badge badge-custom"><?php echo htmlspecialchars($service); ?></span>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap">
                                    <?php foreach ($facilities as $facility): ?>
                                        <span class="badge badge-custom"><?= htmlspecialchars($facility) ?></span>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card info-card h-100">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-wrap">
                                        <?php foreach ($services as $service): ?>
                                            <span class="badge  badge-custom small"><?php echo htmlspecialchars($service); ?></span>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card info-card h-100">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-wrap">
                                        <?php foreach ($facilities as $facility): ?>
                                            <span class="badge  badge-custom small"><?= htmlspecialchars($facility) ?></span>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <?php if (empty($services) && empty($facilities)): ?>
                    <div class="alert alert-info py-2">No service or facility information available.</div>
                <?php endif; ?>
            </section>
        <?php endif; ?>
        ...
        <section class="content-section">
            ...
            <div class="row">
                <div class="col-lg-8 mb-4">
                    <?php if (!empty($center['maps_embed'])): ?>
                        <div class="map-container">
                            <iframe src="<?= htmlspecialchars(convertToEmbedURL($center['maps_embed'])) ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy"></iframe>
                        </div>
                    <?php else: ?>
                    ...
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <?php if (!empty($nearby_places)): ?>
                                <p class="mb-3">Explore these places near <?= htmlspecialchars($center['name'] ?? '') ?>:</p>
                                <div class="d-flex flex-wrap">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <?php if (!empty($center['maps_link'])): ?>
                                    <a href="<?= htmlspecialchars($center['maps_link']) ?>" class="btn btn-outline-primary btn-sm" target="_blank">
                                        <i class="fas fa-map-marked-alt me-1"></i> Google Maps
                                    </a>
                                <?php endif; ?>
                                
                                <?php if (!empty($center['directions_link'])): ?>
                                    <a href="<?= htmlspecialchars($center['directions_link']) ?>" class="btn btn-primary btn-sm" target="_blank">
                    ...
                    <?php if (!empty($social_links)): ?>
                        <div class="card info-card">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (!empty($center['mobile_app'])): ?>
                                    <hr class="my-3">
                                    <div class="d-flex flex-wrap gap-1">
                                        <a href="<?= htmlspecialchars($center['mobile_app']) ?>" class="btn btn-dark btn-sm" target="_blank">
