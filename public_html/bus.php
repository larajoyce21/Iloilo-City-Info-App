...
if (isset($_GET['search'])) {
    ...
    if ($_SESSION['search_trigger']['table'] === 'bus') {
...
<div class="album py-5" id="buses">
    <div class="container">
        <br>
        <br>
        <br>
        <br>
        <h1 class="page-title text-light text-center">Bus Routes in Iloilo City</h1> 
        
        <div class="card-container">
            <?php if ($buses_exist): ?>
                <?php while ($bus = $result->fetch_assoc()): ?>
                    <div class="card shadow-sm">
                        <img src="<?= htmlspecialchars($bus['image']) ?>" class="card-img-top" alt="<?= htmlspecialchars($bus['name']) ?>">
                        <div class="card-body text-center">
                            <h6 class="card-title"><?= htmlspecialchars($bus['name']) ?></h6>
                            <?php if (!empty($bus['details_link'])): ?>
                                <a href="<?= htmlspecialchars($bus['details_link']) ?>" class="card-button">
                                    View Details
                                </a>
                            <?php else: ?>
