...
$query = "SELECT * FROM call_centers WHERE id = 10";
...
if (!empty($center['nearby_places'])) {
    $nearby_places = json_decode($center['nearby_places'], true);
...
$locations = array_filter(array_map('trim', explode('|', $center['location'] ?? '')));
?>
...
<head>
    ...
    <title><?= htmlspecialchars($center['name']) ?> - Iloilo Call Centers</title>
...
<main class="container mb-4">
    ...
    <section class="content-section">
        <h2 class="section-title">📌 Call Center Information</h2>
        <!-- Desktop  -->
        <div class="row d-none d-md-flex">
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">ℹ️ Services</h5>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($center['services'])): ?>
                            <ul class="services-list">
                                <?php 
                                    $services = explode(',', $center['services']);
                                    foreach ($services as $service): 
                                ?>
                                    <li><i class="fas fa-check-circle"></i> <?php echo htmlspecialchars(trim($service)); ?></li>
                                <?php endforeach; ?>
                            </ul>
                        <?php endif; ?>
                    </div>
