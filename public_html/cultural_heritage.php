...
<br>
<br>
<h1 class="page-title text-light text-center">Cultural Heritage in Iloilo City</h1>
<br>
<!-- Icon Cards  -->
<div class="container mt-4">
    <div class="row justify-content-center">
        ...
        <div class="col-6 col-md-4 col-lg-2 mb-3">
            <a href="historicals.php" class="text-decoration-none">
                <div class="card icon-card h-100">
                    <div class="card-body text-center">
                        <i class="fas fa-monument"></i>
                        <h6 class="card-title mt-2">Historical and Architectural Landmarks</h6>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-2 mb-3">
            <a href="culturals.php" class="text-decoration-none">
                <div class="card icon-card h-100">
                    <div class="card-body text-center">
                        <i class="fas fa-palette"></i>
                        <h6 class="card-title mt-2">Museum and Art Galleries</h6>
                    </div>
                </div>
            </a>
        </div>
        ...
        <!-- <div class="col-6 col-md-4 col-lg-2 mb-3">
            <a href="cultural_practices.php" class="text-decoration-none">
                <div class="card icon-card h-100">
                    <div class="card-body text-center">
                        <i class="fas fa-hands-helping"></i>
                        <h6 class="card-title mt-2">Cultural Practices and Traditions</h6>
                    </div>
                </div>
            </a>
        </div> -->
        ...
        <!-- Arts and Crafts -->
        <!-- <div class="col-6 col-md-4 col-lg-2 mb-3">
            <a href="arts.php" class="text-decoration-none">
                <div class="card icon-card h-100">
                    <div class="card-body text-center">
                        <i class="fas fa-brush"></i>
                        <h6 class="card-title mt-2">Arts and Crafts</h6>
                    </div>
                </div>
            </a>
        </div> -->
        ...
        <!-- Clothing and Attire -->
        <!-- <div class="col-6 col-md-4 col-lg-2 mb-3">
            <a href="attires.php" class="text-decoration-none">
                <div class="card icon-card h-100">
                    <div class="card-body text-center">
                        <i class="fas fa-tshirt"></i>
                        <h6 class="card-title mt-2">Clothing and Attire</h6>
                    </div>
                </div>
            </a>
        </div> -->
        ...
        <div class="col-6 col-md-4 col-lg-2 mb-3">
            <a href="history_literatures.php" class="text-decoration-none">
                <div class="card icon-card h-100">
                    <div class="card-body text-center">
                        <i class="fas fa-book-open"></i>
                        <h6 class="card-title mt-2">History and Literature </h6>
                    </div>
                </div>
            </a>
        </div>

        <!-- Cultural Tourism & Souvenirs -->
        <div class="col-6 col-md-4 col-lg-2 mb-3">
            <a href="souvenirs.php" class="text-decoration-none">
                <div class="card icon-card h-100">
                    <div class="card-body text-center">
                        <i class="fas fa-gift"></i>
                        <h6 class="card-title mt-2">Local Souvenirs</h6>
                    </div>
                </div>
            </a>
        </div>
