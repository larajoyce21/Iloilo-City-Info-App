...
// In the PHP section where you're getting chart data, update the searches query:
$result = $conn->query("
...
// Get data for tables - FIXED: Exclude password field from users query
...
<body>
    ...
    <div class="main-content" id="main-content">
        <div class="container-fluid">
                ...
                <?php if (!empty($search_query)): ?>
                    <div class="mt-3">
                        ...
                        <?php if (array_sum(array_map('count', $search_results)) > 0): ?>
                            ...
                            <!-- User Results - FIXED: No password displayed -->
                ...
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-9">
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-outline-primary" onclick="setTimePeriod('today')">Today</button>
                            <button type="button" class="btn btn-outline-primary" onclick="setTimePeriod('week')">This Week</button>
                            <button type="button" class="btn btn-outline-primary" onclick="setTimePeriod('month')">This Month</button>
            ...
            <!-- Key Metrics - Updated to include posts -->
            <div class="row mb-4">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="mt-2 text-muted text-sm">
                                        <span class="<?= $stats['period_visitors'] > 0 ? 'text-success' : 'text-danger' ?>">
                                            <i class="fas fa-arrow-<?= $stats['period_visitors'] > 0 ? 'up' : 'down' ?>"></i>
                                            <?= number_format($stats['period_visitors']) ?> in period
                                        </span>
                                    </div>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="col-md-4">
                        <div class="metric-card card">
                            <div class="card-body">
                                ...
                                <div class="metric-value"><?= isset($stats['new_users_30days']) ? number_format($stats['new_users_30days']) : '0' ?></div>
                                <div class="metric-change up">
                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                        <div class="metric-card card">
                            <div class="card-body">
                                <h5>Total Visits</h5>
                                <div class="metric-value"><?= number_format($stats['total_visitors']) ?></div>
                                <div class="metric-change up">
                    ...
                    <div class="col-md-4">
                        <div class="metric-card card">
                            <div class="card-body">
                                ...
                                <div class="metric-value"><?= number_format($stats['unique_visitors']) ?></div>
                                <div class="metric-change up">
                                    <i class="fas fa-arrow-up"></i> 10% from last period
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="analytics-section" id="search-analytics">
                    ...
                    <div class="col-md-4">
                        <div class="metric-card card">
                            <div class="card-body">
                                ...
                                <div class="metric-change up">
                                    <i class="fas fa-arrow-up"></i> <?= round(($stats['total_searches'] - array_sum(array_column($chartData['failed_searches'], 'count')) / max(1, $stats['total_searches']) * 100) )?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="metric-card card">
                            <div class="card-body">
                                ...
                                <div class="metric-change up">
                                    <i class="fas fa-arrow-up"></i> <?= round(($stats['total_searches'] - array_sum(array_column($chartData['failed_searches'], 'count')) / max(1, $stats['total_searches']) * 100)) ?>% of total
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="metric-card card">
                            <div class="card-body">
                                ...
                                <div class="metric-change down">
                                    <i class="fas fa-arrow-down"></i> <?= round(array_sum(array_column($chartData['failed_searches'], 'count')) / max(1, $stats['total_searches']) * 100) ?>% of total
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Top Successful Search Terms</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php 
                                            if (!empty($chartData['searches'])) {
                                                foreach ($chartData['searches'] as $row): 
                                                    $total_for_term = $conn->query(
                                                        "SELECT COUNT(*) as total 
                                                        FROM search_logs 
                                                        WHERE query = '" . $conn->real_escape_string($row['query']) . "'");
                                                    $total = $total_for_term->fetch_assoc()['total'];
                                                    $success_rate = round(($row['count'] / $total) * 100);
                                            ?>
                                            <tr>
                                            ...
                                            <?php 
                                                ...
                                                echo '<tr><td colspan="3" class="text-center">No successful search data available</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Top Failed Search Terms</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php 
                                            if (!empty($chartData['failed_searches'])) {
                                                foreach ($chartData['failed_searches'] as $row): 
                                                    $total_for_term = $conn->query(
                                                        "SELECT COUNT(*) as total 
                                                        FROM search_logs 
                                                        WHERE query = '" . $conn->real_escape_string($row['query']) . "'");
                                                    $total = $total_for_term->fetch_assoc()['total'];
                                                    $failure_rate = round(($row['count'] / $total) * 100);
                                            ?>
                                            <tr>
                                                <td><?= htmlspecialchars($row['query']) ?></td>
                                                <td><?= $row['count'] ?></td>
                                                <td>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-danger" role="progressbar" style="width: <?= $failure_rate ?>%" aria-valuenow="<?= $failure_rate ?>" aria-valuemin="0" aria-valuemax="100"><?= $failure_rate ?>%</div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php 
                                                ...
                                                echo '<tr><td colspan="3" class="text-center">No failed search data available</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
            ...
            <div class="analytics-section" id="analytics">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="chart-container">
                            <canvas id="listingsByCategoryChart"></canvas>
                        </div>
                    </div>
                </div>
            ...
            <!-- Recent Users Section - FIXED: No password displayed -->
            ...
            <section class="mt-5" id="services-section">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a href="dashboard.php?edit=0" class="btn btn-primary">
                ...
                <?php if (isset($_GET['edit'])): ?>
                    <div class="card mb-4">
                        <div class="card-header">
                            <h4><?php echo $edit_data ? 'Edit Service' : 'Add New Service'; ?></h4>
                        </div>
                        <div class="card-body">
                            <form method="post">
                                    ...
                                    <select name="services_id" class="form-select" required>
                                        ...
                                        while ($cat = $categories->fetch_assoc()): ?>
                                            <option value="<?php echo $cat['id']; ?>" 
                                                <?php if (isset($edit_data['services_id']) && $edit_data['services_id'] == $cat['id']) echo 'selected'; ?>>
                                                <?php echo $cat['name']; ?>
                                            </option>
                                        <?php endwhile; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" required><?php 
                                        echo $edit_data['description'] ?? ''; 
                                    ?></textarea>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label">Services Offered</label>
                                    <textarea name="services" class="form-control" rows="3" required><?php 
                                        echo $edit_data['services_offered'] ?? ''; 
                                    ?></textarea>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label">Requirements (one per line)</label>
                                    <textarea name="requirements" class="form-control" rows="3"><?php 
                                        echo $edit_data['requirements'] ?? ''; 
                                    ?></textarea>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="contact" class="form-control" required 
                                               value="<?php echo $edit_data['contact'] ?? ''; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="hours" class="form-control" required 
                                               value="<?php echo $edit_data['hours'] ?? ''; ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Emoji Icon</label>
                                        <input type="text" name="icon" class="form-control" required 
                                               value="<?php echo $edit_data['icon'] ?? ''; ?>">
                                    </div>
                                </div>
                            ...
                            <?php if (isset($edit_data)): ?>
                                <div class="mt-4">
                                    ...
                                    <?php if (count($documents) > 0): ?>
                                        <?php foreach ($documents as $doc): ?>
                                            <div class="document-item">
                                                ...
                                                <div>
                                                    <a href="download.php?id=<?php echo $doc['id']; ?>" class="btn btn-sm btn-info">
                                                        <i class="fas fa-download me-1"></i> Download
                                                    </a>
                                                    <a href="dashboard.php?delete=<?php echo $doc['id']; ?>&type=document&service_id=<?php echo $edit_data['id']; ?>" 
                                                       class="btn btn-sm btn-danger" 
                                    ...
                                    <?php else: ?>
                                        <p>Maximum of 10 documents reached for this service.</p>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <?php foreach ($services_by_services_category as $services_category => $services): ?>
                    <div class="card mb-4">
                        <div class="card-header">
                            <h4><?php echo $services_category; ?></h4>
                        </div>
                        <div class="card-body">
                                ...
                                <?php foreach ($services as $service): ?>
                                    <div class="service-card">
                                        <div>
                                            ...
                                            <p class="text-muted mb-0"><?php echo $service['location']; ?></p>
                                        </div>
                                        <div>
                                            <a href="dashboard.php?edit=<?php echo $service['id']; ?>" class="btn btn-sm btn-warning">
                                                <i class="fas fa-edit me-1"></i> Edit
                                            </a>
                                            <a href="dashboard.php?delete=<?php echo $service['id']; ?>&type=service" 
                                               class="btn btn-sm btn-danger" 
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.setTimePeriod = function(period) {
            ...
            window.location.href = 'dashboard.php?time_period=' + days + 'days';
        }
...
function initializeCharts() {
    ...
    if (userGrowthCtx) {
        const data = <?= json_encode($chartData['user_growth'] ?? []) ?>;
        if (data.length > 0) {
            ...
            userGrowthCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No user growth data available</p>';
        }
    }

    // Posts Growth Chart
    const postsGrowthCtx = document.getElementById('postsGrowthChart');
    if (postsGrowthCtx) {
        const data = <?= json_encode($chartData['posts_growth'] ?? []) ?>;
        if (data.length > 0) {
            new Chart(postsGrowthCtx, {
                type: 'line',
                data: {
                    labels: data.map(item => item.month),
                    datasets: [{
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Community Posts Growth Over Time',
                            font: {
                                size: 16
                            }
                        },
            ...
            postsGrowthCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No posts growth data available</p>';
        }
    }

    // Posts Stats Chart (Doughnut)
    ...
    if (postsStatsCtx) {
        ...
        if (postsWithImages > 0 || postsWithoutImages > 0) {
            new Chart(postsStatsCtx, {
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Posts with Images Distribution',
                            font: {
                                size: 16
                            }
                        },
            ...
            postsStatsCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No posts data available</p>';
        }
    }

    // User Locations Chart (Bar Chart)
    const userLocationsCtx = document.getElementById('userLocationsChart');
    if (userLocationsCtx) {
        const data = <?= json_encode($chartData['user_locations'] ?? []) ?>;
        if (data.length > 0) {
            new Chart(userLocationsCtx, {
                type: 'bar',
                data: {
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'User Locations by Location',
                            font: {
                                size: 16
                            }
                        },
            ...
            userLocationsCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No user location data available</p>';
        }
    }
    ...
    if (monthlyVisitorsCtx) {
        const data = <?= json_encode($chartData['monthly'] ?? []) ?>;
        if (data && data.length > 0) {
            new Chart(monthlyVisitorsCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Visitors',
                        data: data.map(item => parseInt(item.visits)),
                        backgroundColor: 'rgba(78, 115, 223, 0.05)',
                        borderColor: '#4e73df',
                        borderWidth: 2,
                        pointBackgroundColor: '#4e73df',
            ...
            monthlyVisitorsCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No monthly visitor data available</p>';
        }
    }
    ...
    if (deviceUsageCtx) {
        const data = <?= json_encode($chartData['device_usage'] ?? []) ?>;
        if (data.length > 0) {
            ...
            deviceUsageCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No device usage data available</p>';
        }
    }

    // Search Success Chart (Doughnut)
    ...
    if (searchSuccessCtx) {
        ...
        if (successCount > 0 || failCount > 0) {
            ...
            searchSuccessCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No search data available</p>';
        }
    }

    // Search Terms Chart (Bar)
    const searchTermsCtx = document.getElementById('searchTermsChart');
    if (searchTermsCtx) {
        const data = <?= json_encode($chartData['searches'] ?? []) ?>;
        if (data.length > 0) {
            ...
            searchTermsCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No search term data available</p>';
        }
    }

    // Listings Chart (Bar Chart)
    const listingsCtx = document.getElementById('listingsChart');
    if (listingsCtx) {
        const data = <?= json_encode($chartData['listings'] ?? []) ?>;
        if (data.length > 0) {
            new Chart(listingsCtx, {
                type: 'bar',
                data: {
                    labels: data.map(item => item.name.length > 15 ? item.name.substring(0, 12) + '...' : item.name),
                    datasets: [{
                        label: 'Views',
            ...
            listingsCtx.closest('.chart-container').innerHTML = '<p class="text-muted">No listing view data available</p>';
        }
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // General delete confirmation for all delete buttons
        document.querySelectorAll('a[href*="delete="]').forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                // Set appropriate confirmation message based on type
                ...
                switch(type) {
                    case 'user':
                        ...
                        break;
                    case 'business':
                        message = 'WARNING: Deleting this business will permanently remove:\n- The business listing\n- All associated images\n\nAre you sure you want to proceed?';
                        break;
                    case 'business_image':
                        message = 'Are you sure you want to delete this image? This cannot be undone.';
                        break;
                    case 'category':
                        message = 'WARNING: Deleting this category will remove it from the system.\n\nIf this category has businesses assigned to it, the deletion will fail.\n\nAre you sure you want to proceed?';
                        break;
                    case 'icon_card':
                        message = 'Are you sure you want to delete this icon card? This will remove it from all pages.';
                        break;
                    case 'contact':
                    ...
                    case 'announcement':
                        ...
                        break;
                    case 'service':
                        message = 'Are you sure you want to delete this service and all its associated documents?';
                        break;
                    case 'document':
