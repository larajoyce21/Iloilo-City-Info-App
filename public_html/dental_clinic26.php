...
$query = "SELECT * FROM dental_clinics WHERE id = 26";
...
if (!empty($clinic['services'])) {
    $decoded = json_decode($clinic['services'], true);
...
if (!empty($clinic['nearby_places'])) {
    $decoded = json_decode($clinic['nearby_places'], true);
...
<head>
    ...
    <title><?= htmlspecialchars($clinic['name']) ?> - Iloilo Dental Clinics</title>
    ...
    <style>
        ...
        /* Transport Options (from apartment1.php) */
        .transport-option {
            margin-bottom: 10px;
        }
...
<main class="container mb-4">
    ...
    <section class="content-section">
        <h2 class="section-title">­Ъди Dental Clinic Information</h2>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">Рё╣№ИЈ About Our Clinic</h5>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($clinic['specialization'])): ?>
                            <p class="mt-2 mb-0"><strong>Specialization:</strong> <?= htmlspecialchars($clinic['specialization']) ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">­ЪЋњ Operating Hours</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">­ЪЊъ Contact Information</h5>
                    </div>
                    <div class="card-body">
                        <p class="mb-2">­ЪЊ▓ Phone: <?= htmlspecialchars($clinic['contact'] ?? '') ?></p>
                        <?php if (!empty($clinic['email'])): ?>
                            <p class="mb-2">­ЪЊД Email: <?= htmlspecialchars($clinic['email']) ?> </p>
                        <?php endif; ?>
                        <?php if (!empty($clinic['website'])): ?>
                            <p class="mb-2">­Ъїљ Website: <a href="<?= htmlspecialchars($clinic['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">Рё╣№ИЈ About Our Clinic</h6>
                        </div>
                        <div class="card-body">
                            <?php if (!empty($clinic['specialization'])): ?>
                                <p class="mt-2 mb-0 small"><strong>Specialization:</strong> <?= htmlspecialchars($clinic['specialization']) ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">­ЪЋњ Operating Hours</h6>
                        </div>
                        <div class="card-body">
                            <?= nl2br(htmlspecialchars($clinic['hours'])) ?>
                        </div>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="card info-card">
                        <div class="card-header">
                            <h6 class="mb-0">­ЪЊъ Contact Information</h6>
                        </div>
                        <div class="card-body">
                            <p class="mb-2 small">­ЪЊ▓ Phone: <?= htmlspecialchars($clinic['contact'] ?? '') ?></p>
                            <?php if (!empty($clinic['email'])): ?>
                                <p class="mb-2 small">­ЪЊД Email: <?= htmlspecialchars($clinic['email']) ?> </p>
                            <?php endif; ?>
                            <?php if (!empty($clinic['website'])): ?>
                                <p class="mb-2 small">­Ъїљ Website: <a href="<?= htmlspecialchars($clinic['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <section class="content-section">
        <h2 class="section-title">РџЋ№ИЈ Dental Services</h2>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-12">
                <div class="card info-card">
                    <div class="card-header">
                        <h5 class="mb-0">Our Professional Services</h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="d-md-none">
            <div class="row">
                <div class="col-12">
                    <div class="card info-card">
                        <div class="card-header">
                            <h6 class="mb-0">Our Professional Services</h6>
                        </div>
                        <div class="card-body">
                            <div class="d-flex flex-wrap">
                                <?php foreach ($services as $service): ?>
                                    <span class="service-badge small"><?= htmlspecialchars($service) ?></span>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
    ...
    <!-- location -->
    <section class="content-section">
        <h2 class="section-title">­ЪЊЇ Location & Directions</h2>
        
        <div class="row">
            <div class="col-lg-8 mb-3">
                <?php if (!empty($clinic['maps_embed'])): ?>
                    <div class="map-container">
                        <iframe src="<?= htmlspecialchars(convertToEmbedURL($clinic['maps_embed'])) ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy"></iframe>
                    </div>
                <?php else: ?>
            ...
            <div class="col-lg-4">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">­ЪЌ║№ИЈ Nearby Places</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <h5 class="mb-2 small fw-bold">­ЪћЌ Links</h5>
        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="card info-card">
                    <div class="card-header">
                        <h5 class="mb-0">­ЪџЌ Transportation Information</h5>
                    </div>
                    <div class="card-body">
                        <?php 
        ...
        <div class="row">
            <div class="col-12">
                <?php if (!empty($social_links)): ?>
                    <div class="card info-card">
                        <div class="card-header">
                            <h5 class="mb-0">­ЪЊ▒ Connect With Us</h5>
                        </div>
                        <div class="card-body">
                            <div class="d-flex flex-wrap">
    ...
    <?php if (!empty($clinic['emergency_contact'])): ?>
    <section class="content-section">
        <div class="row">
            <div class="col-12">
                <div class="card emergency-card">
                    <div class="card-header">
                        <h5 class="mb-0">­Ъџе Emergency Dental Care</h5>
                    </div>
                    <div class="card-body">
                        <p class="mb-2"><strong>Emergency Contact:</strong> <?= htmlspecialchars($clinic['emergency_contact']) ?></p>
                        <p class="mb-2"><strong>Available:</strong> 24/7 for dental emergencies</p>
                        <p class="mb-0 small">For after-hours dental emergencies, please call the number above immediately.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row row-cols-3 g-3 text-center text-sm-start">
            <div class="col">
                ...
                <p class="text-white small mb-2">
                    Discover Iloilo City Рђћ rich in culture, history, and heart.
                </p>
