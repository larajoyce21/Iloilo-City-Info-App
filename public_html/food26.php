...
$query = "SELECT * FROM foods WHERE id = 26";
...
if (!empty($food['nearby_places'])) {
    $decoded = json_decode($food['nearby_places'], true);
...
$branches = [];
if (!empty($food['branches'])) {
    $branches = array_filter(array_map('trim', explode("\n", $food['branches'])));
}

$locations = array_filter(array_map('trim', explode('|', $food['location'] ?? '')));
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?= htmlspecialchars($food['name']) ?> - Iloilo Food Heritage</title>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($food['menu'] ?? '')) ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($food['menu'] ?? '')) ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
        ...
        <div class="row d-none d-md-flex">
                        ...
                        <div class="row">
                            <?php if (!empty($food['price_range'])): ?>
                                <div class="col-md-6 mb-2">
                                    ...
                                    <p class="mb-2"><?= nl2br(htmlspecialchars($food['price_range'])) ?></p>
                                </div>
                            <?php endif; ?>
                            
                            <p class="mb-2">📲 Phone: <?= htmlspecialchars($food['contact'] ?? '') ?></p>
                            <?php if (!empty($food['email'])): ?>
                                <p class="mb-2">📧 Email: <?= htmlspecialchars($food['email']) ?></p>
                            <?php endif; ?>
                            <?php if (!empty($food['website'])): ?>
                                <p class="mb-2">🌐 Website: <a href="<?= htmlspecialchars($food['website']) ?>" target="_blank" class="text-decoration-none">Visit Website</a></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?= nl2br(htmlspecialchars($food['hours'])) ?>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <?php if (!empty($food['price_range'])): ?>
                                    <div class="col-12 mb-2">
                                        ...
                                        <p class="mb-2 small"><?= nl2br(htmlspecialchars($food['price_range'])) ?></p>
                                    </div>
                                <?php endif; ?>
                                    
                                <p class="mb-2 small">📲 Phone: <?= htmlspecialchars($food['contact'] ?? '') ?></p>
                                <?php if (!empty($food['email'])): ?>
                                    <p class="mb-2 small">📧 Email: <?= htmlspecialchars($food['email']) ?> </p>
                                <?php endif; ?>
                                <?php if (!empty($food['website'])): ?>
                                    <p class="mb-2 small">🌐 Website: <a href="<?= htmlspecialchars($food['website']) ?>" target="_blank" class="text-decoration-none"> Visit Website</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 mb-3">
                <div class="card info-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-2"><strong>📅 Established:</strong> <?= htmlspecialchars($food['year_established'] ?? '') ?></p>
                                <p class="mb-2"><strong>🍽️ Cuisine:</strong> <?= htmlspecialchars($food['cuisine'] ?? '') ?></p>
                                <p class="mb-2"><strong>⭐ Specialty:</strong> <?= htmlspecialchars($food['specialty'] ?? '') ?></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-2"><strong>💵 Price Range:</strong> <?= htmlspecialchars($food['price_range'] ?? '') ?></p>
                                <p class="mb-2"><strong>🌟 Popular Items:</strong> <?= htmlspecialchars($food['popular_items'] ?? '') ?></p>
                                <p class="mb-2"><strong>⭐ Best Seller:</strong> <?= htmlspecialchars($food['best_seller'] ?? '') ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 mb-3">
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-1 small"><strong>📅 Established:</strong> <?= htmlspecialchars($food['year_established'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>🍽️ Cuisine:</strong> <?= htmlspecialchars($food['cuisine'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>⭐ Specialty:</strong> <?= htmlspecialchars($food['specialty'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>💵 Price Range:</strong> <?= htmlspecialchars($food['price_range'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>🌟 Popular Items:</strong> <?= htmlspecialchars($food['popular_items'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>⭐ Best Seller:</strong> <?= htmlspecialchars($food['best_seller'] ?? '') ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
