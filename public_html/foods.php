...
if (isset($_GET['search'])) {
    ...
    if ($_SESSION['search_trigger']['table'] === 'foods') {
...
<div class="album py-5" id="foods">
    <div class="container">
        <br>
        <br>
        <br>
        <br>
        <h1 class="page-title text-light text-center">Eat like a Local in Iloilo City</h1> 
        ...
        <div class="card-container">
            <?php if ($foods_exist): ?>
                <?php while ($food = $result->fetch_assoc()): ?>
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body text-center">
                            ...
                            <?php if (!empty($food['details_link'])): ?>
                                <a href="<?= htmlspecialchars($food['details_link']) ?>" class="card-button">
                                    View Details
                                </a>
                            <?php else: ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <div class="alert alert-info">No food landmarks found.</div>
            <?php endif; ?>
        </div>
    </div>
</div>
