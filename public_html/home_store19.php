...
$query = "SELECT * FROM home_stores WHERE id = 19";
...
if (empty($transport_routes) && !empty($store['transportation_options'])) {
    $transport_options = explode("\n", $store['transportation_options']);
...
<head>
    ...
    <title><?php echo htmlspecialchars($store['name']); ?> - Home Store/Depot</title>
        ...
        <div class="row d-none d-md-flex">            
                        ...
                        <?php if (!empty($branches)): ?>
                            <ul class="list-unstyled mb-0">
                                <?php foreach ($branches as $branch): ?>
                                    <li class="mb-1 small">📍 <?= htmlspecialchars($branch) ?></li>
                                <?php endforeach; ?>
                            </ul>
                        <?php else: ?>
                            <p class="mb-0 small text-muted">No branch information available</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($store['hours'] ?? '')) ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-3">
        ...
        <div class="row">
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <?php 
                                $categories = explode(',', $store['product_categories']);
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php 
                            $services = explode(',', $store['services']);
                        ...
                        ?>
                            <div class="service-item">
                                ...
                                <div>
                                    <h6 class="mb-0 small"><?= htmlspecialchars(trim($service)) ?></h6>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
