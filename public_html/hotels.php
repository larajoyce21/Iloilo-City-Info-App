...
if (isset($_GET['search'])) {
    ...
    if ($_SESSION['search_trigger']['table'] === 'hotels') {
...
$hotels_exist = $result->num_rows > 0;
?>
<!doctype html>
<html lang="en">
<head>
...
<div class="album py-5" id="hotels">
    <div class="container">
        <br>
        <br>
        <br>
        <br>
        <h1 class="page-title text-light text-center">Hotels and Accomodations in Iloilo City </h1> 
                ...
                <?php while ($hotel = $result->fetch_assoc()): ?>
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body text-center">
                            ...
                            <?php if (!empty($hotel['details_link'])): ?>
                                <a href="<?= htmlspecialchars($hotel['details_link']) ?>" class="card-button">
                                    View Details
                                </a>
                            <?php else: ?>
