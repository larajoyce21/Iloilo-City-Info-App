...
$query = "SELECT * FROM medical_diagnostic_clinics WHERE id = 20";
...
if (!empty($clinic['image_detail'])) {
    $detail_images = explode(',', $clinic['image_detail']);
}
...
if (!empty($clinic['services'])) {
    if (strpos($clinic['services'], '[') === 0) {
        $services = json_decode($clinic['services'], true);
        if (!is_array($services)) {
            $services = array_filter(array_map('trim', explode(',', $clinic['services'])));
        }
    } else {
        $services = array_filter(array_map('trim', explode(',', $clinic['services'])));
    }
...
if (!empty($clinic['specialties'])) {
    if (strpos($clinic['specialties'], '[') === 0) {
...
$locations = array_filter(array_map('trim', explode('|', $clinic['location'] ?? '')));
...
<head>
    ...
    <title><?= htmlspecialchars($clinic['name']) ?> - Iloilo Medical Clinics</title>
...
<main class="container mb-4">
    ...
    <?php if (!empty($services) || !empty($specialties)): ?>
    <section class="content-section">
        <h2 class="section-title">🔬 Medical Services & Specialties</h2>
        ...
        <div class="row d-none d-md-flex">
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">🎯 Medical Specialties</h5>
                    </div>
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($clinic['emergency_services']) && $clinic['emergency_services'] == 'Yes'): ?>
                            <span class="emergency-badge">🆘 24/7 Emergency Services Available</span>
                        <?php endif; ?>                       
                         <?php if (!empty($clinic['accreditation'])): ?>
                            <p class="mt-2 mb-0"><strong>Accreditation:</strong> <?= htmlspecialchars($clinic['accreditation']) ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>                            
                            <?php if (!empty($clinic['accreditation'])): ?>
                                <p class="mt-2 mb-0 small"><strong>Accreditation:</strong> <?= htmlspecialchars($clinic['accreditation']) ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <?php if (!empty($social_links)): ?>
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (!empty($clinic['mobile_app'])): ?>
                                <hr class="my-3">
                                <div class="d-flex flex-wrap gap-1">
                                    <a href="<?= htmlspecialchars($clinic['mobile_app']) ?>" class="btn btn-dark btn-sm" target="_blank">
