...
if (isset($_GET['search'])) {
    ...
    if ($_SESSION['search_trigger']['table'] === 'restaurants') {
...
if ($stmt = $conn->prepare($query)) {
    ...
    $restaurants_exist = $result->num_rows > 0;
    $stmt->close();
}
?>
...
<div class="album py-5" id="restaurants">
    <div class="container">
        <br>
        <br>
        <br>
        <br>
        <h1 class="page-title text-light text-center">Restaurants and Cafes in Iloilo City</h1> 
        
        <div class="card-container">
            <?php if ($restaurants_exist): ?>
                <?php while ($restaurant = $result->fetch_assoc()): ?>
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body text-center">
                            <h6 class="card-title"><?= htmlspecialchars($restaurant['name']) ?></h6>
                            <?php if (!empty($restaurant['details_link'])): ?>
                                <a href="<?= htmlspecialchars($restaurant['details_link']) ?>" class="card-button">
                                    View Details
                                </a>
                            <?php else: ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <div class="alert alert-info">No restaurant found.</div>
            <?php endif; ?>
        </div>
    </div>
</div>
