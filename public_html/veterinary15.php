...
$query = "SELECT * FROM veterinary_clinics WHERE id = 15";
...
$veterinarians = !empty($clinic['veterinarians'])
    ? array_filter(array_map('trim', explode("\n", $clinic['veterinarians'])))
    : [];

$branches = [];
if (!empty($clinic['branches'])) {
...
<head>
    ...
    <title><?= htmlspecialchars($clinic['name']) ?> - Iloilo Veterinary Clinics</title>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">🏬 Clinic Branches</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <p class="mb-0"><?= nl2br(htmlspecialchars($clinic['specialties'] ?? '')) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">👨‍⚕️ Veterinarians</h5>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($veterinarians)): ?>
                            <ul class="list-group list-group-flush">
                                <?php foreach ($veterinarians as $vet): ?>
                                    <li class="list-group-item border-0 px-0 py-1">
                                        <div class="d-flex align-items-start">
                                            <i class="fas fa-user-md text-primary mt-1 me-2"></i>
                                            <span class="small"><?= htmlspecialchars($vet) ?></span>
                                        </div>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        <?php else: ?>
                            <p class="mb-0">No veterinarian information available.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0">🏬 Clinic Branches</h6>
                        </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body ">
                            <p class="mb-0 small"><?= nl2br(htmlspecialchars($clinic['specialties'] ?? '')) ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    <div class="card info-card">
                        <div class="card-header">
                            <h6 class="mb-0">👨‍⚕️ Veterinarians</h6>
                        </div>
                        <div class="card-body small">
                            <?php if (!empty($veterinarians)): ?>
                                <ul class="list-group list-group-flush">
                            ...
                            <?php else: ?>
                                <p class="mb-0 small">No veterinarian information available.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php if (!empty($clinic['accessibility'])): ?>
                                <div class="col-12 mb-2">
                                    <h6 class="fw-bold">🏠 Amenities</h6>
                                    <p class="mb-2"><?= htmlspecialchars($clinic['accessibility']) ?></p>
                                </div>
                            <?php endif; ?>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="alert alert-info mb-0 py-2 small">Service information coming soon.</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-2"><strong>📅 Established:</strong> <?= htmlspecialchars($clinic['established'] ?? '') ?></p>
                                <p class="mb-2"><strong>🐾 Pet Types:</strong> <?= htmlspecialchars($clinic['pet_types'] ?? '') ?></p>
                                <p class="mb-2"><strong>🚑 Emergency Services:</strong> <?= htmlspecialchars($clinic['emergency_services'] ?? '') ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p class="mb-1 small"><strong>📅 Established:</strong> <?= htmlspecialchars($clinic['established'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>🐾 Pet Types:</strong> <?= htmlspecialchars($clinic['pet_types'] ?? '') ?></p>
                                    <p class="mb-1 small"><strong>🚑 Emergency:</strong> <?= htmlspecialchars($clinic['emergency_services'] ?? '') ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-1">
                            ...
                            <?php if (!empty($clinic['directions'])): ?>
                                <a href="<?= htmlspecialchars($clinic['directions']) ?>" class="btn btn-primary btn-sm" target="_blank">
