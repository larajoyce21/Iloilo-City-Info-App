...
$query = "SELECT * FROM wellness_spas WHERE id = 22";
...
if (!empty($spa['transportation_routes'])) {
    $routes_data = json_decode($spa['transportation_routes'], true);
...
$nearby_places = [];
if (!empty($spa['nearby_places'])) {
    $nearby_places = json_decode($spa['nearby_places'], true) ?: [];
}

$detail_images = array_filter(explode(',', $spa['image_detail'] ?? ''));
...
$booking_policy = [];
if (!empty($spa['booking_policy'])) {
    $booking_policy = explode("\n", $spa['booking_policy']);
}
?>
...
<head>
    ...
    <title><?= htmlspecialchars($spa['name'] ?? 'Wellness Spa') ?> - Iloilo Wellness & Relaxation</title>
    ...
    <style>
       ...
       /* Navbar */
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?= htmlspecialchars($spa['image'] ?? 'img/default-spa.jpg') ?>');
...
<section class="hero-section" 
  style="background:linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)),url('<?= htmlspecialchars($spa['image'] ?? 'img/default-spa.jpg') ?>') center/cover no-repeat;">
  <div class="container">
    <h1 class="display-4 fw-bold mb-3"><?= htmlspecialchars($spa['name'] ?? '') ?></h1>
    <p class="lead"><?= htmlspecialchars($spa['location'] ?? '') ?></p>
  </div>
</section>

<main class="container mb-4">
    <section class="content-section">
      <h2 class="section-title">About <?= htmlspecialchars($spa['name'] ?? '') ?></h2>
      <div class="lead mb-4">
        <?= nl2br(htmlspecialchars($spa['description'] ?? '')) ?>
      </div>
        ...
        <div class="slideshow-container">
          <?php foreach ($detail_images as $index => $image): ?>
            <div class="slide <?= $index === 0 ? 'active' : '' ?>">
              <img src="<?= htmlspecialchars($image) ?>" alt="<?= htmlspecialchars($spa['name']) ?> Image <?= $index + 1 ?>">
      ...
      <?php else: ?>
        <div class="slideshow-container default-image">
    ...
    <section class="content-section">
        <h2 class="section-title">💆‍♀️ Spa Services & Amenities</h2>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-md-6 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-spa me-2"></i> Treatment Services</h5>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($spa['services'])): ?>
                            <ul class="service-list">
                                ...
                                foreach ($services as $service):
                                    if (trim($service) != ''): 
                                        ...
                                        $service_price = isset($parts[1]) ? trim($parts[1]) : '';
                                    ?>
                                        <li>
                                            <div>
                                            ...
                                            <?php if (!empty($service_price)): ?>
                                                <span class="price-tag"><?= htmlspecialchars($service_price) ?></span>
                                            <?php endif; ?>
                                        </li>
                                    <?php endif;
                                endforeach; ?>
            ...
            <div class="col-md-6 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fas fa-concierge-bell me-2"></i> Facilities & Amenities</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <h6 class="fw-bold small">🏊‍♀️ Spa Facilities</h6>
                            <p class="small"><?= !empty($spa['facilities']) ? htmlspecialchars($spa['facilities']) : '' ?></p>
                        </div>
                        
                        <div class="mb-3">
                            <h6 class="fw-bold small">♿ Accessibility</h6>
                            <p class="small"><?= !empty($spa['accessibility']) ? htmlspecialchars($spa['accessibility']) : '' ?></p>
                        </div>
                        
                        <div>
                            <h6 class="fw-bold small">⭐ Spa Type</h6>
                            <p class="small"><?= !empty($spa['type']) ? htmlspecialchars($spa['type']) : '' ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-md-none mobile-side-by-side">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0"><i class="fas fa-spa me-2"></i> Treatment Services</h6>
                        </div>
                                    ...
                                    foreach ($services as $service):
                                        ...
                                        ?>
                                            <li>
                                                <div>
                                                    <i class="fas fa-check-circle text-success me-2"></i>
                                                    <span class="small"><?= htmlspecialchars($service_name) ?></span>
                                                </div>
                                                <?php if (!empty($service_price)): ?>
                                                    <span class="price-tag small"><?= htmlspecialchars($service_price) ?></span>
                                                <?php endif; ?>
                                            </li>
                                        <?php endif;
                                    endforeach; ?>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        <div class="card-header">
                            <h6 class="mb-0"><i class="fas fa-concierge-bell me-2"></i> Facilities & Amenities</h6>
                        </div>
                        <div class="card-body">
                            <div class="mb-2">
                                <h6 class="fw-bold small">🏊‍♀️ Spa Facilities</h6>
            ...
            <div class="col-12">
                <div class="card info-card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-2"><strong>📲 Phone:</strong> <?= htmlspecialchars($spa['contact'] ?? '') ?></p>
                                <?php if (!empty($spa['email'])): ?>
                                    <p class="mb-2"><strong>📧 Email:</strong> <?= htmlspecialchars($spa['email']) ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6">
                                <?php if (!empty($spa['website'])): ?>
                                    <p class="mb-2"><strong>🌐 Website:</strong> <a href="<?= htmlspecialchars($spa['website']) ?>" target="_blank" class="text-decoration-none">Visit Website</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row d-none d-md-flex">
            <div class="col-lg-7 mb-3">
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($spa['hours'])): ?>
                            <div class="spa-hours">
                                <?= nl2br(htmlspecialchars($spa['hours'])) ?>
                            </div>
                        <?php else: ?>
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            ...
                            <p class="small"><?= !empty($spa['established']) ? htmlspecialchars($spa['established']) : '' ?></p>
                        </div>
                        
                        <div class="mb-2">
                            <h6 class="fw-bold small">💆 Services</h6>
                            <p class="small"><?= !empty($spa['services']) ? count(array_filter(explode("\n", $spa['services']))) . '' : '' ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-8 mb-3">
                <div class="card info-card h-100">
                    <div class="card-header">
                        <h6 class="mb-0">📅 Booking Policy</h6>
                    </div>
                    <div class="card-body">
                        <p class="small mb-0"><?= nl2br(htmlspecialchars($spa['booking_policy'])) ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card info-card h-100">
                        ...
                        <div class="card-body small">
                            <?php if (!empty($spa['hours'])): ?>
                                <div class="spa-hours small">
                                    <?= nl2br(htmlspecialchars($spa['hours'])) ?>
                                </div>
                            <?php else: ?>
                                <p class="text-muted small">Operating hours not specified.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <section class="content-section">
        ...
        <div class="row">
            <div class="col-lg-8 mb-3">
                <?php if (!empty($spa['maps_embed'])): ?>
                    <div class="map-container">
                        <iframe src="<?= htmlspecialchars(convertToEmbedURL($spa['maps_embed'])) ?>" width="100%" height="100%" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                <?php else: ?>
                    <div class="map-container default-image">
                        <div class="d-flex flex-column align-items-center justify-content-center h-100">
                ...
                <div class="card info-card h-100">
                    ...
                    <div class="card-body">
                        <?php if (!empty($nearby_places)): ?>
                            <p class="mb-2 small">Explore these places near <?= htmlspecialchars($spa['name'] ?? 'this spa') ?>:</p>
                        ...
                        <div class="d-flex flex-wrap gap-1">
                            <?php if (!empty($spa['maps_link'])): ?>
                                <a href="<?= htmlspecialchars($spa['maps_link']) ?>" class="btn btn-outline-primary btn-sm" target="_blank">
                                    <i class="fas fa-map-marked-alt me-1"></i> Maps
                                </a>
                            <?php endif; ?>
                            
                            <?php if (!empty($spa['directions_link'])): ?>
                                <a href="<?= htmlspecialchars($spa['directions_link']) ?>" class="btn btn-primary btn-sm" target="_blank">
    ...
    <section class="content-section">
        <div class="row">
            <div class="col-12">
                <div class="card info-card">
                    <div class="card-header">
                        <h5 class="mb-0">📱 Connect & Book</h5>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($social_links)): ?>
                            <h5 class="mb-2 small fw-bold">🔗 Social Media</h5>
                        ...
                        <div class="d-flex flex-wrap gap-1 mb-3">
                            <?php if (!empty($spa['contact'])): ?>
                                <a href="tel:<?= htmlspecialchars(preg_replace('/[^0-9+]/', '', $spa['contact'])) ?>" class="btn btn-outline-primary btn-sm">
                                    <i class="fas fa-phone me-1"></i> Call Spa
                                </a>
                            <?php endif; ?>
                            
                            <?php if (!empty($spa['email'])): ?>
                                <a href="mailto:<?= htmlspecialchars($spa['email']) ?>" class="btn btn-outline-secondary btn-sm">
...
<footer class="footer mt-5 py-4 text-white">
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-3 g-3 text-center text-sm-start">
            <div class="col">
