...
$result = $conn->query("SELECT * FROM travel_agencies");

$searchNameToTrigger = '';
if (isset($_GET['search'])) {
    $searchNameToTrigger = $_GET['search'];
} elseif (isset($_SESSION['search_trigger'])) {
    if ($_SESSION['search_trigger']['table'] === 'travel_agencies') {
...
<html lang="en">
  <head>
    ...
    <title>TOURS AND TRAVEL AGENCIES</title>
...
<div class="album py-5" id="agencies">
    <div class="container">
        <br>
        <br>
        <br>
        <br>
        <h1 class="page-title text-light text-center">Tours and Travel Agencies in Iloilo City</h1> 
        ...
        <div class="card-container">
            <?php if ($result): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <div class="alert alert-info">No travel_agency found.</div>
            <?php endif; ?>
        </div>
    </div>
</div>
